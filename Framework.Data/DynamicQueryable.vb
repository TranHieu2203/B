...
Namespace System.Linq.Dynamic
    ...
    Public MustInherit Class DynamicClass
        Public Overrides Function ToString() As String
            Dim props = Me.GetType().GetProperties(Reflection.BindingFlags.Instance Or Reflection.BindingFlags.Public)
    ...
    Friend Class ClassFactory
        ...
        Private Sub New()
            ...
            Dim assembly As Reflection.Emit.AssemblyBuilder = AppDomain.CurrentDomain.DefineDynamicAssembly(name, AssemblyBuilderAccess.Run)
    ...
    Class ExpressionParser
        ...
        Function ParseComparison() As Expression
            ...
            Do While tokenVal.id = TokenId.Equal OrElse tokenVal.id = TokenId.DoubleEqual OrElse _
                ...
                If (isEquality AndAlso Not left.Type.IsValueType AndAlso Not right.Type.IsValueType) _
                   OrElse (left.Type = GetType(Guid) AndAlso right.Type = GetType(Guid)) Then
