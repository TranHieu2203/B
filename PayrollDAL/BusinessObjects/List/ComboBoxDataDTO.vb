Public Class ComboBoxDataDTO
    ...
    Public Property GET_NORM_ID As Boolean
    Public Property LIST_NORM_ID As List(Of OT_OTHERLIST_DTO)

    Public Property GET_INCOME_TYPE As Boolean
    Public Property LIST_INCOME_TYPE As List(Of OT_OTHERLIST_DTO)
    Public Property GET_TYPE_SHOP As Boolean
    Public Property LIST_TYPE_SHOP As List(Of OT_OTHERLIST_DTO)
    Public Property GET_BRAND As Boolean
    Public Property LIST_BRANDID As List(Of OT_OTHERLIST_DTO)

    Public Property GET_TARGET_GROUP As Boolean
    Public Property LIST_TARGET_GROUP As List(Of OT_OTHERLIST_DTO)
End Class
