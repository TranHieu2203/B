...
Public Class ctrlInsManagerChange
...
#Region "Function & Sub"
    ...
    Private Function LoadDataGrid(Optional ByVal isFull As Boolean = False) As DataTable
        ...
        Try
            ...
            Dim lstSource As List(Of INS_CHANGE_INFO_DTO)
            ...
            End If
            If rdMonthFrom.SelectedDate.HasValue Then
                obj.MONTH_FROM = rdMonthFrom.SelectedDate
            End If
            If rdMonthTo.SelectedDate.HasValue Then
                obj.MONTH_TO = rdMonthTo.SelectedDate
            End If
            obj.IS_TERMINATE = chkChecknghiViec.Checked

            If Not isFull Then
                If Sorts IsNot Nothing Then
                    lstSource = rep.GetChangeInfo(obj, Utilities.ObjToInt(ctrlOrg.CurrentValue), "", rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, Sorts)
                Else
                    lstSource = rep.GetChangeInfo(obj, Utilities.ObjToInt(ctrlOrg.CurrentValue), "", rgData.CurrentPageIndex, rgData.PageSize, MaximumRows)
                End If
                rgData.DataSource = lstSource
                rgData.MasterTableView.VirtualItemCount = MaximumRows
            Else
                If Sorts IsNot Nothing Then
                    Return rep.GetChangeInfo(obj, Utilities.ObjToInt(ctrlOrg.CurrentValue), "", , , , Sorts).ToTable
                Else
                    Return rep.GetChangeInfo(obj, Utilities.ObjToInt(ctrlOrg.CurrentValue), "").ToTable
                End If
        ...
        Try
            ...
            Select Case CurrentState
                Case CommonMessage.STATE_DELETE
                    ...
                    Next
                    If rep.DeleteChangeInfo(lstDeletes) Then
                        Refresh("UpdateView")
                        UpdateControlState()
                    Else
                        CurrentState = CommonMessage.STATE_NORMAL
