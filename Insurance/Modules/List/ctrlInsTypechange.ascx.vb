...
Public Class ctrlInsTypechange
        ...
        Try
            Select Case CType(e.Item, RadToolBarButton).CommandName
                ...
                Case CommonMessage.TOOLBARITEM_EXPORT
                    Dim lstSource As DataTable = (New InsuranceBusiness.InsuranceBusinessClient).GetInsTypeChange(True)
                    Using xls As New ExcelCommon
                        If lstSource.Rows.Count > 0 Then
                            rgGridData.ExportExcel(Server, Response, lstSource, "DS_Loai_Thay_Doi")
                        Else
    ...
    Private Sub ctrlMessageBox_ButtonCommand(ByVal sender As Object, ByVal e As MessageBoxEventArgs) Handles ctrlMessageBox.ButtonCommand
        Try
            ...
            If e.ActionName = CommonMessage.TOOLBARITEM_DEACTIVE And e.ButtonID = MessageBoxButtonType.ButtonYes Then
                ...
                Next
                Dim rep As New InsuranceBusiness.InsuranceBusinessClient
                If rep.UpdateStatusForList(Common.Common.GetUsername(), "TYPE_CHANGE" _
                                                                 , lstActive _
...
#Region "Function & Sub"
    ...
    Private Sub SaveData()
        Try
            ...
            Select Case CurrentState
                Case CommonMessage.STATE_NEW
                    If rep.UpdateInsTypeChange(Common.Common.GetUsername(), InsCommon.getNumber(txtID.Text) _
                                                                            , txtCODE.Text _
                                                                            , txtNAME.Text _
                                                                            , txtNote.Text) Then
                        Refresh("InsertView")
    ...
    Private Sub DeleteData()
        Try
            ...
            Dim item As GridDataItem = rgGridData.SelectedItems(0)
            txtID.Text = item.GetDataKeyValue("ID").ToString()
            If rep.DeleteInsTypeChange(InsCommon.getNumber(txtID.Text)) Then
                Refresh("UpdateView")
            Else
                ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_FAIL), Utilities.NotifyType.Error)
            End If
