<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPortalResultRecordHistory.ascx.vb"
    Inherits="Performance.ctrlPortalResultRecordHistory" %>
...
<%--<style type="text/css">
    ...
    #ctrlResultRecordHistory_rgData_GridData
    {
...
<tlk:RadScriptBlock runat="server" ID="ScriptBlock">
    <script type="text/javascript">
        var splitterID = 'ctl00_MainContent_ctrlResultRecordHistory_RadSplitter3';
        var pane1ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlResultRecordHistory_RadPane1';
        var pane2ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlResultRecordHistory_RadPane2';
        var validateID = 'MainContent_ctrlResultRecordHistory_valSum';
