<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPortalMngInfoEvalTargetNewEdit.ascx.vb"
    Inherits="Performance.ctrlPortalMngInfoEvalTargetNewEdit" %>
...
<tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Orientation="Horizontal">
    <tlk:RadPane ID="RadPane1" runat="server" Height="400px" Scrolling="Y">
        ...
        <div style="margin-top: 15px;">
            <tlk:RadGrid ID="rgData" AllowPaging="true" runat="server" EditMode="InPlace" Height="250px"
                Scrolling="None">
                ...
                <MasterTableView AllowPaging="false" AllowCustomPaging="false" DataKeyNames="ID,KPI_ASSESSMENT_TEXT,IS_IN_DB,EMPLOYEE_POINT,RATIO"
                    ClientDataKeyNames="ID,KPI_ASSESSMENT_TEXT" CommandItemDisplay="Top">
                        ...
                        <div style="padding: 2px 0 0 0">
                            <div style="float: left">
                                <tlk:RadButton Width="112px" ID="btnResult" runat="server" Text="Ghi nhận KQ" Icon-PrimaryIconUrl="~/Static/Images/Toolbar/import1.png"
                                    CausesValidation="false" CommandName="Result" TabIndex="5" OnClientClicked="btnResultClick"
                                    AutoPostBack="false">
                                </tlk:RadButton>
                                <tlk:RadButton Width="112px" ID="btnResultHistory" runat="server" Text="Xem lịch sử"
                                    Icon-PrimaryIconUrl="~/Static/Images/Toolbar/document_ok.png" CausesValidation="false"
                                    CommandName="ResultHistory" TabIndex="6" OnClientClicked="btnResultHistoryClick"
                                    AutoPostBack="false">
                                </tlk:RadButton>
                            </div>
                        </div>
                    ...
                    <Columns>
                        ...
                        <tlk:GridNumericColumn HeaderText="Điểm NV" DataField="EMPLOYEE_POINT" UniqueName="EMPLOYEE_POINT"
                            DataFormatString="{0:N2}" HeaderStyle-Width="75px" ReadOnly="true" SortExpression="EMPLOYEE_POINT"
                            ItemStyle-HorizontalAlign="Center" />
                        <tlk:GridBoundColumn HeaderText="Ghi chú" DataField="NOTE" UniqueName="NOTE" HeaderStyle-Width="75px"
                            ReadOnly="true" SortExpression="NOTE" ItemStyle-HorizontalAlign="Center" />
                        ...
                        <tlk:GridNumericColumn HeaderText="Điểm đánh giá" DataField="DIRECT_POINT" UniqueName="DIRECT_POINT"
                            DataFormatString="{0:N2}" HeaderStyle-Width="75px" ReadOnly="true" SortExpression="DIRECT_POINT"
                            ItemStyle-HorizontalAlign="Center" />
        ...
        function btnResultHistoryClick(sender, args) {
            ...
            if (bCheck == 0) {
                ...
                if (goalID == 0) {
                    ...
                    var oWindow = radopen('Dialog.aspx?mid=Performance&fid=ctrlPortalResultRecordHistory&Criteria=All&GoalID=' + goalID, "rwPopup");
                    var pos = $("html").offset();
                ...
                if (goalID == 0) {
                    ...
                    var oWindow = radopen('Dialog.aspx?mid=Performance&fid=ctrlPortalResultRecordHistory&Criteria=' + str + '&GoalID=' + goalID, "rwPopup");
                    var pos = $("html").offset();
                    oWindow.moveTo(pos.left, pos.top);
                    oWindow.maximize();
                }
        ...
        function btnResultClick(sender, args) {
            ...
            if (bCheck > 0) {
                ...
                if (goalID == 0) {
                    ...
                    var oWindow = radopen('Dialog.aspx?mid=Performance&fid=ctrlPortalResultRecord&Criteria=' + str + '&GoalID=' + goalID, "rwPopup");
                    var pos = $("html").offset();
                    oWindow.moveTo(pos.left, pos.top);
                    oWindow.maximize();
                }
