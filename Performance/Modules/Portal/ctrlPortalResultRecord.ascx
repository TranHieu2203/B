<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPortalResultRecord.ascx.vb"
    Inherits="Performance.ctrlPortalResultRecord" %>
...
<%--<style type="text/css">
    ...
    #ctrlResultRecord_rgData_GridData
    {
            ...
            <MasterTableView DataKeyNames="ID,TARGET_TYPE_CODE,EMPLOYEE_ACTUAL" ClientDataKeyNames="ID,TARGET_TYPE_CODE,EMPLOYEE_ACTUAL" EditMode="InPlace" EditFormSettings-EditFormType="AutoGenerated">
                ...
                <Columns>
                    ...
                    <tlk:GridNumericColumn HeaderText="Điểm NV" DataField="EMPLOYEE_POINT" UniqueName="EMPLOYEE_POINT"
                        HeaderStyle-Width="100px" ReadOnly="true" SortExpression="EMPLOYEE_POINT" ItemStyle-HorizontalAlign="Center" />
                    ...
                    <tlk:GridTemplateColumn HeaderText="<%$ Translate: QL Đánh giá %>" UniqueName="DIRECT_ACTUAL" HeaderStyle-Width="100px">
                        <ItemTemplate>
                            <%# DataBinder.Eval(Container.DataItem, "DIRECT_ACTUAL")%>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <tlk:RadTextBox ID="txtDIRECT_ACTUAL" runat="server"
                                CausesValidation="false" Width="100%" AutoPostBack="true" OnTextChanged="txtDIRECT_ACTUAL_TextChanged">
                            </tlk:RadTextBox>
                        </EditItemTemplate>
                    </tlk:GridTemplateColumn>
                    <tlk:GridTemplateColumn HeaderText="<%$ Translate: Điểm QL %>" UniqueName="DIRECT_POINT" HeaderStyle-Width="100px">
                        <ItemTemplate>
                            <%# DataBinder.Eval(Container.DataItem, "DIRECT_POINT")%>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <tlk:RadNumericTextBox ID="rnDIRECT_POINT" runat="server" SkinID="Decimal"
                                CausesValidation="false" Width="100%" AutoPostBack="true" OnTextChanged="rnDIRECT_POINT_TextChanged">
                            </tlk:RadNumericTextBox>
                        </EditItemTemplate>
                    </tlk:GridTemplateColumn> 
                    <tlk:GridTemplateColumn HeaderText="<%$ Translate: Ghi chú của QLTT %>" UniqueName="NOTE_QLTT" HeaderStyle-Width="300px">
                        <ItemTemplate>
                            <%# DataBinder.Eval(Container.DataItem, "NOTE_QLTT")%>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <tlk:RadTextBox ID="txtNOTE_QLTT" runat="server"
                                CausesValidation="false" Width="100%" AutoPostBack="true" OnTextChanged="txtNOTE_QLTT_TextChanged">
                            </tlk:RadTextBox>
                        </EditItemTemplate>
                    </tlk:GridTemplateColumn>    
                </Columns>
...
<tlk:RadScriptBlock runat="server" ID="ScriptBlock">
    <script type="text/javascript">
        var splitterID = 'ctl00_MainContent_ctrlResultRecord_RadSplitter3';
        var pane1ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlResultRecord_RadPane1';
        var pane2ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlResultRecord_RadPane2';
        var validateID = 'MainContent_ctrlResultRecord_valSum';
