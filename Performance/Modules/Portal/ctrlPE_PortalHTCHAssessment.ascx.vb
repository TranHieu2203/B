...
Imports WebAppLog
Public Class ctrlPE_PortalHTCHAssessment
    Inherits CommonView
...
#Region "Page"
    ...
    Protected Sub InitControl()
        Try
            ...
            MainToolBar.Items(1).Text = Translate("Ghi nhận ĐG")
            MainToolBar.Items(5).Text = Translate("DS Chi tiết")
        Catch ex As Exception
            DisplayException(Me.ViewName, Me.ID, ex)
        End Try
    End Sub
            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                Case CommonMessage.TOOLBARITEM_DELETE
                    ...
                    For idx = 0 To rgMngInfoEvalTarget.SelectedItems.Count - 1
                        ...
                        If item.GetDataKeyValue("STATUS_ID") <> PortalStatus.Saved And item.GetDataKeyValue("STATUS_ID") <> PortalStatus.UnApprovedByLM Then
                ...
                Case CommonMessage.TOOLBARITEM_EXPORT
                    Using xls As New ExcelCommon
                        ...
                        If dtDatas.Rows.Count > 0 Then
                            rgMngInfoEvalTarget.ExportExcel(Server, Response, dtDatas, "HTCH Assessment")
                        End If
                    End Using
    ...
    Private Sub ctrlMessageBox_ButtonCommand(ByVal sender As Object, ByVal e As MessageBoxEventArgs) Handles ctrlMessageBox.ButtonCommand
        If e.ActionName = CommonMessage.TOOLBARITEM_SUBMIT And e.ButtonID = MessageBoxButtonType.ButtonYes Then
            ...
            If rgMngInfoEvalTarget.SelectedItems.Count = 1 Then
                ...
                Try
                    outNumber = rep.PRI_PROCESS_APP(sItem.GetDataKeyValue("EMPLOYEE_ID"), sItem.GetDataKeyValue("PERIOD_ID"), "PERFORMANCE_HTCH", 0, 0, 0, strId, "")
                Catch ex As Exception
            ...
            ElseIf rgMngInfoEvalTarget.SelectedItems.Count > 1 Then
                For Each dr As GridDataItem In rgMngInfoEvalTarget.SelectedItems
                    ...
                    Dim period = CDec(dr.GetDataKeyValue("PERIOD_ID"))
                    Dim outNumber As Decimal

                    Try
                        outNumber = rep.PRI_PROCESS_APP(dr.GetDataKeyValue("EMPLOYEE_ID"), period, "PERFORMANCE_HTCH", 0, 0, 0, strId, "")
                    Catch ex As Exception
                        ShowMessage(ex.ToString, NotifyType.Error)
                    End Try
        ...
        Try
            ...
            If isFull Then
                If Sorts IsNot Nothing Then
                    Return rep.GetHTCHAssessment(_filter, lstOrg, Sorts).ToTable()
                Else
                    Return rep.GetHTCHAssessment(_filter, lstOrg).ToTable()
                End If
            Else
                If Sorts IsNot Nothing Then
                    rgMngInfoEvalTarget.DataSource = rep.GetHTCHAssessment(_filter, lstOrg, rgMngInfoEvalTarget.CurrentPageIndex, rgMngInfoEvalTarget.PageSize, MaximumRows, Sorts)
                Else
                    rgMngInfoEvalTarget.DataSource = rep.GetHTCHAssessment(_filter, lstOrg, rgMngInfoEvalTarget.CurrentPageIndex, rgMngInfoEvalTarget.PageSize, MaximumRows)
                End If
