...
Public Class ctrlPE_CriteriaTitlegroupRank
    ...
    Public Overrides Sub BindData()
        Try
            Using rep As New PerformanceRepository
                ...
                Dim rep1 As New PerformanceStoreProcedure
                dtData = rep1.GET_CRITERIA_HTCH(True)
...
#Region "Function & Sub"
    ...
    Protected Function CreateDataFilter(Optional ByVal isFull As Boolean = False) As DataTable
        ...
        Try
            ...
            Dim lstSource As List(Of CriteriaTitleGroupRankDTO)
            ...
            If cboCriteria.SelectedValue <> "" Then
                obj.CRITERIA_ID = cboCriteria.SelectedValue
            End If

            If Not isFull Then
                If Sorts IsNot Nothing Then
                    lstSource = rep.getCriteriaTitleGroupRank(obj, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, Sorts)
                Else
                    lstSource = rep.getCriteriaTitleGroupRank(obj, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows)
                End If
                rgData.DataSource = lstSource
                rgData.MasterTableView.VirtualItemCount = MaximumRows
            Else
                Return rep.getCriteriaTitleGroupRank(obj, 0, Integer.MaxValue, 0).ToTable
            End If
            '    _mylog.WriteLog(_mylog._info, _classPath, method,
            '                                       CLng(DateTime.UtcNow.Subtract(startTime).TotalSeconds).ToString(), "")
        Catch ex As Exception
        ...
        Try
            ...
            Select Case CurrentState
                Case CommonMessage.STATE_DELETE
                    ...
                    If rep.DeleteCriteriaTitleGroupRank(lstDeletes) Then
                        Refresh("UpdateView")
                        UpdateControlState()
                    Else
                        CurrentState = CommonMessage.STATE_NORMAL
