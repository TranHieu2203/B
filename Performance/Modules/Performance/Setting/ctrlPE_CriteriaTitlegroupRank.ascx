<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPE_CriteriaTitlegroupRank.ascx.vb"
    Inherits="Performance.ctrlPE_CriteriaTitlegroupRank" %>
            ...
            <tlk:RadPane ID="RadPane1" runat="server" Height="80px" Scrolling="None">
                ...
                <table class="table-form" onkeydown="return (event.keyCode!=13)">
                    ...
                    <tr>
                        ...
                        <td>
                            <tlk:RadComboBox ID="cboCriteria" runat="server">
                            </tlk:RadComboBox>
                        </td>
                        <td>
                    ...
                    <MasterTableView DataKeyNames="ID,GROUPTITLE_ID" ClientDataKeyNames="ID">
                        <Columns>
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Nhóm chức danh %>" DataField="GROUPTITLE_NAME"
                             ...
                             <tlk:GridBoundColumn HeaderText="<%$ Translate: Tiêu chí đánh giá %>" DataField="NAME"
                                SortExpression="NAME" UniqueName="NAME" HeaderStyle-Width="120px">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </tlk:GridBoundColumn>
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Ghi chú %>" DataField="NOTE"
                             ...
                             <tlk:GridBoundColumn HeaderText="<%$ Translate: Thang điểm %>" DataField="CRITERIA_NAME"
...
<tlk:RadScriptBlock ID="scriptBlock" runat="server">
    <script type="text/javascript">
        ...
        function OpenInsertWindow() {
            var oWindow = radopen('Dialog.aspx?mid=Performance&fid=ctrlPE_CriteriaTitlegroupRankNewEdit&group=Setting&FormType=0&noscroll=1', "rwPopup");
        ...
        function OpenEditWindow() {
            ...
            if (id > 0) {
                var oWindow = radopen('Dialog.aspx?mid=Performance&fid=ctrlPE_CriteriaTitlegroupRankNewEdit&group=Setting&VIEW=TRUE&FormType=0&ID=' + id + '&noscroll=1', "rwPopup");
                oWindow.maximize(true);
                oWindow.center();
            }
        }
