<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPE_EmployeePeriod.ascx.vb"
    Inherits="Performance.ctrlPE_EmployeePeriod" %>
        ...
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadGrid PageSize="50" ID="rgData" runat="server" Height="100%"
                    ...
                    <MasterTableView DataKeyNames="ID,EMPLOYEE_ID,EMAIL,SEND_MAIL" ClientDataKeyNames="ID,EMPLOYEE_ID">
                        <Columns>
                            ...
                            <tlk:GridBoundColumn HeaderText="Số tháng đánh giá" DataField="MONTH_NUMBER" SortExpression="MONTH_NUMBER"
                                UniqueName="MONTH_NUMBER" />
                            <tlk:GridBoundColumn HeaderText="Email" DataField="EMAIL" SortExpression="EMAIL"
                                UniqueName="EMAIL" />
