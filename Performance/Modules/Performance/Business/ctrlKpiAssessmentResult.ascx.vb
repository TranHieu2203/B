...
Public Class ctrlKpiAssessmentResult
...
#Region "Page"
    ...
    Protected Sub InitControl()
        ...
        Try
            ...
            Common.Common.BuildToolbar(Me.MainToolBar, ToolbarItem.Calculate, ToolbarItem.Lock,
                                       ToolbarItem.Unlock,
                                       ToolbarItem.Delete,
                                       ToolbarItem.Export)
        Catch ex As Exception
                ...
                Case CommonMessage.STATE_DELETE
                    ...
                    For Each item In rgData.MasterTableView.GetSelectedItems
                        ...
                        If item.GetDataKeyValue("IS_LOCK") Then
                            ShowMessage(Translate("Tồn tại bản ghi đang ở trạng thái đã khóa. Không thể thực hiện thao tác"), NotifyType.Warning)
                            Exit Sub
                        End If
                    Next
                    If rep.DeleteKpiAssessmentResult(objID) Then
            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                ...
                Case CommonMessage.TOOLBARITEM_EXPORT
                    ...
                    Using xls As New ExcelCommon
                        ...
                        If dtData.Rows.Count > 0 Then
                            rgData.ExportExcel(Server, Response, dtData, "KPI_ASSESSMENT_RESULT")
                        Else
                ...
                Case CommonMessage.TOOLBARITEM_LOCK
                    ...
                    For Each item As GridDataItem In rgData.SelectedItems
                        ...
                        End If
                    Next
                    ctrlMessageBox.MessageText = "Bạn có muốn khóa đánh giá mục tiêu đã chọn?"
                ...
                Case CommonMessage.TOOLBARITEM_UNLOCK
                    ...
                    For Each item As GridDataItem In rgData.SelectedItems
                        If item.GetDataKeyValue("IS_LOCK") <> -1 Then
                            ShowMessage(Translate("Tồn tại bản ghi ở trạng thái đã mở khóa"), NotifyType.Warning)
                            Exit Sub
                        End If
                    Next
                    ctrlMessageBox.MessageText = "Bạn có muốn mở khóa đánh giá mục tiêu đã chọn?"
        ...
        Try
            ...
            If e.ActionName = CommonMessage.TOOLBARITEM_LOCK And e.ButtonID = MessageBoxButtonType.ButtonYes Then
                ...
                For idx = 0 To rgData.SelectedItems.Count - 1
                    ...
                    lstIds.Add(item.GetDataKeyValue("ID"))
                Next
                Using rep As New PerformanceRepository
...
#Region "Custom"
    ...
    Protected Function CreateDataFilter(Optional ByVal isFull As Boolean = False) As DataTable
        Dim _filter As New KPI_ASSESSMENT_RESULT_DTO
        Dim rep As New PerformanceRepository
        ...
        Try
            ...
            Else
                rgData.DataSource = New List(Of KPI_ASSESSMENT_RESULT_DTO)
                Exit Function
            End If
            ...
            If isFull Then
                If Sorts IsNot Nothing Then
                    Return rep.GetKpiAssessmentResult(_filter, _param, Sorts).ToTable()
                Else
                    Return rep.GetKpiAssessmentResult(_filter, _param).ToTable()
                End If
            Else
                If Sorts IsNot Nothing Then
                    rgData.DataSource = rep.GetKpiAssessmentResult(_filter, rgData.CurrentPageIndex,
                                                     rgData.PageSize, MaximumRows, _param, Sorts)
                Else
                    rgData.DataSource = rep.GetKpiAssessmentResult(_filter, rgData.CurrentPageIndex,
                                                     rgData.PageSize, MaximumRows, _param)
                End If
