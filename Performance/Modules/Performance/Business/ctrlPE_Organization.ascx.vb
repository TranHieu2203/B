...
Public Class ctrlPE_Organization
        ...
        Try
            Select Case CurrentState
                Case CommonMessage.STATE_DELETE
                    ...
                    Next
                    If rep.DeletePe_Organization(lstDeletes) Then
                        Refresh("UpdateView")
                        UpdateControlState()
                    Else
                ...
                Case CommonMessage.TOOLBARITEM_EXPORT
                    Using xls As New ExcelCommon
                        ...
                        If dtDatas.Rows.Count > 0 Then
                            rgData.ExportExcel(Server, Response, dtDatas, "PlanRegister")
                        End If
                    End Using
            End Select
...
#Region "Custom"
    ...
    Protected Function CreateDataFilter(Optional ByVal isFull As Boolean = False) As DataTable
        Dim _filter As New PE_ORGANIZATIONDTO
        Dim rep As New PerformanceRepository
        ...
        Try
            ...
            If Not isFull Then
                If Sorts IsNot Nothing Then
                    lstData = rep.GetPe_Organization(_filter, _param, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, Sorts)
                Else
                    lstData = rep.GetPe_Organization(_filter, _param, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows)
                End If
            Else
                If Sorts IsNot Nothing Then
                    Return rep.GetPe_Organization(_filter, _param, , , , Sorts).ToTable
                Else
                    Return rep.GetPe_Organization(_filter, _param).ToTable
                End If
