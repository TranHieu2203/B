<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPA_AOMs_TOMByManage.ascx.vb"
    Inherits="Payroll.ctrlPA_AOMs_TOMByManage" %>
        ...
        <tlk:RadSplitter ID="RadSplitter2" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            ...
            <tlk:RadPane ID="RadPane1" runat="server" Height="80px" Scrolling="None">
                <table class="table-form">
                    ...
                    <tr>
                         <td class="lb">
                            <asp:Label ID="lbOrgName" runat="server" Text="CH/Đvị quản lý "></asp:Label><span class="lbReq">*</span>
                        </td>
                        <td>
                         ...
                         <td class="lb">
                            <%# Translate("Tháng hiệu lực")%>
                        </td>
                        <td>
                            <tlk:RadMonthYearPicker runat="server" ID="rdEffect_date" TabIndex="5" Culture="en-US">
                             ...
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="rdEffect_date"
                                runat="server" Text="*" ErrorMessage="<%$ Translate: Bạn phải nhập Tháng hiệu lực. %>"></asp:RequiredFieldValidator>
                        </td>
                        <td class="lb">
                            <%# Translate("Tháng hết hiệu lực")%>
                        </td>
                        <td>
                            <tlk:RadMonthYearPicker runat="server" ID="rdEXPIRE_DATE" TabIndex="5" Culture="en-US">
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadGrid PageSize="50" ID="rgWorkschedule" runat="server" Height="100%">
                    <MasterTableView DataKeyNames="ID,EMPLOYEE_CODE,ORG_DESC" ClientDataKeyNames="ID,EMPLOYEE_ID,EMPLOYEE_CODE,EMPLOYEE_NAME,ORG_DV_NAME,ORG_DV_ID,EFFECT_DATE,EXPIRE_DATE">
                        <Columns>
                            ...
                            <tlk:GridTemplateColumn HeaderText="<%$ Translate: Phòng ban %>" DataField="ORG_NAME"
                             ...
                             <tlk:GridBoundColumn HeaderText="<%$ Translate: CH/Đvị quản lý %>" DataField="ORG_DV_NAME"
                                UniqueName="ORG_DV_NAME" SortExpression="ORG_DV_NAME">
                                <HeaderStyle Width="150px" />
                                <ItemStyle Width="150px" />
                            </tlk:GridBoundColumn>
                             <tlk:GridBoundColumn HeaderText="<%$ Translate: Tháng hiệu lực %>" DataField="EFFECT_DATE" DataFormatString="{0:MM/yyyy}" UniqueName="EFFECT_DATE" SortExpression="EFFECT_DATE" 
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Tháng hết hiệu lực %>" DataField="EXPIRE_DATE" DataFormatString="{0:MM/yyyy}" UniqueName="EXPIRE_DATE" SortExpression="EXPIRE_DATE" 
                                FilterControlWidth="99%" ShowFilterIcon="false" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" HeaderStyle-Width="80px"/>
                        </Columns>
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        var splitterID = 'ctl00_MainContent_ctrlPA_AOMs_TOMByManage_RadSplitter3';
        var pane1ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlPA_AOMs_TOMByManage_RadPane1';
        var pane2ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlPA_AOMs_TOMByManage_RadPane2';
        var validateID = 'MainContent_ctrlPA_AOMs_TOMByManage_valSum';
        var oldSize = $('#' + pane1ID).height();

        var txtBoxName = 'ctl00_MainContent_ctrlPA_AOMs_TOMByManage_txtEmpName_wrapper';
        var txtBoxTitle = 'ctl00_MainContent_ctrlPA_AOMs_TOMByManage_txtTitle_wrapper';
        ...
        window.addEventListener('keydown', function (e) {
            if (e.keyIdentifier == 'U+000A' || e.keyIdentifier == 'Enter' || e.keyCode == 13) {
                if (e.target.id !== 'ctl00_MainContent_ctrlPA_AOMs_TOMByManage_txtOrgName') {
                    e.preventDefault();
                    return false;
                }
            }
