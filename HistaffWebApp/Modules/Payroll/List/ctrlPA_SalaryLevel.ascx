        ...
        <table class="table-form">
            <tr>
                ...
                <td colspan="3">
                    ...
                    <asp:RequiredFieldValidator ID="reqSalaryGroup" ControlToValidate="cboSalaryGroup" runat="server"
                        ErrorMessage="<%$ Translate: Bạn phải chọn thang lương %>" ToolTip="<%$ Translate:  Bạn phải chọn thang lương %>">
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        var pane1ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlPA_SalaryLevel_RadPane1';
        var pane2ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlPA_SalaryLevel_RadPane2';
        var validateID = 'MainContent_ctrlPA_SalaryLevel_ValidationSummary1';
