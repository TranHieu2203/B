<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPAFRAME_PRODUCTIVITY.ascx.vb"
    Inherits="Payroll.ctrlPAFRAME_PRODUCTIVITY" %>
<style type="text/css">
    #btnSaveImage {
        display: none;
    }
...
<tlk:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%">
    <tlk:RadPane ID="LeftPane" runat="server" MinWidth="200" Width="400px">
        ...
        <asp:CheckBox ID="cbDissolve" runat="server" Text="<%$ Translate: Hiển thị khung hệ số năng suất ngừng áp dụng %>"
            AutoPostBack="True" />
    </tlk:RadPane>
    ...
    <tlk:RadPane ID="MainPane" runat="server">
        ...
        <table class="table-form">
            <tr>
                <td class="lb">
                    <asp:Label ID="lbParent_Name" runat="server" Text="Khung năng suất cha"></asp:Label>
                </td>
                <td colspan="3">
            ...
            <tr>
                <td class="lb">
                    <asp:Label ID="lbCode" runat="server" Text="Mã khung năng suất"></asp:Label>
                    <span class="lbReq">*</span>
                </td>
                <td>
                    <tlk:RadTextBox ID="txtCode" runat="server" SkinID="Textbox50">
                     ...
                     <asp:RequiredFieldValidator ID="reqCode" ControlToValidate="txtCode" runat="server"
                        ErrorMessage="<%$ Translate: Bạn phải nhập Mã đơn vị %>" ToolTip="<%$ Translate: Bạn phải nhập Mã khung năng suất %>">
                    </asp:RequiredFieldValidator>
                </td>
                <td class="lb">
                    <asp:Label runat="server" ID="lblCoefficient" Text="Hệ số năng suất"></asp:Label>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="reqCoefficient" ControlToValidate="txtCoefficient" runat="server" Enabled="false"
                        ErrorMessage="<%$ Translate: Bạn phải nhập hệ số lương %>" ToolTip="<%$ Translate:  Bạn phải nhập hệ số năng suất %>">
                    </asp:RequiredFieldValidator>
                </td>
            </tr>
            ...
            <tr>
                <td></td>
                <td>
                    <asp:RadioButton runat="server" GroupName="level" ID="chkIslevel1" AutoPostBack="True"/>
                    <asp:Label ID="lbOrgChart" runat="server" Text="Ngạch năng suất"></asp:Label>
                </td>
            </tr>
            <tr>
                <td></td>
                <td>
                    <asp:RadioButton runat="server" GroupName="level" ID="chkIslevel2" AutoPostBack="True"/>
                    <asp:Label ID="Label1" runat="server" Text="Mã, nhóm năng suất"></asp:Label>
                </td>
            </tr>
            <tr>
    ...
    <asp:Button ID="button" runat="server" CausesValidation="false" Text="Test" />
                ...
                <td></td>
                <td>
                    <asp:RadioButton runat="server" GroupName="level" ID="chkIslevel3" AutoPostBack="True"/>
                    <asp:Label ID="Label2" runat="server" Text="Bậc năng suất"></asp:Label>
                </td>
            </tr>
        </table>
    </tlk:RadPane>
