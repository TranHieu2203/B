<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPE_Classification_HTCH.ascx.vb"
    Inherits="Performance.ctrlPE_Classification_HTCH" %>
<tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
        <tlk:RadGrid PageSize="50" ID="rgMain" runat="server" AutoGenerateColumns="False"
            ...
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="CODE,NAME,VALUE_FROM,VALUE_TO,EFFECT_DATE">
                <Columns>
