<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPE_Criteria_HTCH.ascx.vb"
    Inherits="Performance.ctrlPE_Criteria_HTCH" %>
<tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
    <tlk:RadPane ID="RadPane1" runat="server" Height="175px" Scrolling="None">
        ...
        <table class="table-form">
            ...
            <td></td>
                <td>
                    <tlk:RadButton ID="chkIsCheckNew" ToggleType="CheckBox" ButtonType="ToggleButton" runat="server"
                        Text="<%$ Translate: Tiêu chí tổng hợp %>">
                    </tlk:RadButton>
                </td>
                <td>
                    <tlk:RadButton ID="chkIsKyLuat" ToggleType="CheckBox" ButtonType="ToggleButton" runat="server"
                        Text="<%$ Translate: Tiêu chí kỷ luật %>">
                    </tlk:RadButton>
                </td>
            </tr>
        </table>
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
        <tlk:RadGrid PageSize=50  ID="rgMain" runat="server" AutoGenerateColumns="False" AllowPaging="True"
            ...
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="CODE,NAME,DESCRIPTION,IS_CHECK,IS_KYLUAT">
                <Columns>
                    ...
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Mô tả %>" DataField="DESCRIPTION"
                        UniqueName="DESCRIPTION" SortExpression="DESCRIPTION"  HeaderStyle-Width="40%"/>
                    <tlk:GridCheckBoxColumn HeaderText="<%$ Translate: tiêu chí tổng hợp %>" AllowFiltering="false"
                        DataField="IS_CHECK" SortExpression="IS_CHECK" UniqueName="IS_CHECK" />
                    <tlk:GridCheckBoxColumn HeaderText="<%$ Translate: tiêu chí kỷ luật %>" AllowFiltering="false"
                        DataField="IS_KYLUAT" SortExpression="IS_CHECK" UniqueName="IS_KYLUAT" />
                </Columns>
            </MasterTableView>
        </tlk:RadGrid>
    </tlk:RadPane>
