...
<tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
    <tlk:RadPane ID="RadPane1" runat="server" Height="200px" Scrolling="None">
        ...
        <table class="table-form">
            ...
            <tr>
                <td class="lb">
                    <%# Translate("Kiểu đánh giá")%><span class="lbReq">*</span>
                </td>
                <td>
            ...
            <tr>
                ...
                <td class="lb">
                    <%# Translate("Loại nhân viên")%><span class="lbReq">*</span>
                </td>
                <td>
                    <tlk:RadComboBox ID="cboEmployeeType" runat="server">
                    </tlk:RadComboBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="cboEmployeeType"
                        runat="server" ErrorMessage="<%$ Translate: Bạn phải chọn Loại nhân viên %>" ToolTip="<%$ Translate: Bạn phải chọn Loại nhân viên %>">
                    </asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="lb">
                    <%# Translate("TG đề xuất")%><span class="lbReq">*</span>
                </td>
                <td>
                    <tlk:RadNumericTextBox ID="rnNumberDay" runat="server" SkinID="Decimal">
                    </tlk:RadNumericTextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="rnNumberDay" runat="server"
                        ErrorMessage="<%$ Translate: Bạn phải nhập TG đề xuất %>" ToolTip="<%$ Translate: Bạn phải nhập TG đề xuất %>">
                    </asp:RequiredFieldValidator>
                    (<%# Translate("Số ngày")%>)
                </td>
                <td class="lb">
                    <%# Translate("TG đánh giá")%><span class="lbReq">*</span>
                </td>
                <td>
                    <tlk:RadNumericTextBox ID="rnNumberMonth" runat="server" SkinID="Decimal">
                    </tlk:RadNumericTextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="rnNumberMonth" runat="server"
                        ErrorMessage="<%$ Translate: Bạn phải nhập TG đánh giá %>" ToolTip="<%$ Translate: Bạn phải nhập TG đánh giá %>">
                    </asp:RequiredFieldValidator>
                    (<%# Translate("Số tháng")%>)
                </td>
            </tr>
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
        <tlk:RadGrid PageSize="50" ID="rgMain" runat="server" AutoGenerateColumns="False"
            ...
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="YEAR,CODE,NAME,REMARK,START_DATE,END_DATE,TYPE_ASS,EMPLOYEE_TYPE,EMPLOYEE_TYPE_NAME,NUMBER_DAY,NUMBER_MONTH">
                <Columns>
                    ...
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Ngày kết thúc %>" DataField="END_DATE"
                        UniqueName="END_DATE" SortExpression="END_DATE" DataFormatString="{0:dd/MM/yyyy}" CurrentFilterFunction="EqualTo" />
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Ghi chú %>" DataField="REMARK" UniqueName="REMARK"
                        SortExpression="REMARK" />
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Trạng thái %>" DataField="ACTFLG"
                        UniqueName="ACTFLG" SortExpression="ACTFLG" />
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Loại nhân viên %>" DataField="EMPLOYEE_TYPE_NAME"
                        UniqueName="EMPLOYEE_TYPE_NAME" SortExpression="EMPLOYEE_TYPE_NAME" />
                    <tlk:GridNumericColumn HeaderText="<%$ Translate: TG đề xuất%>" DataField="NUMBER_DAY"
                        ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px" SortExpression="NUMBER_DAY"
                        UniqueName="NUMBER_DAY" ReadOnly="true">
                    </tlk:GridNumericColumn>
                    <tlk:GridNumericColumn HeaderText="<%$ Translate: TG đánh giá %>" DataField="NUMBER_MONTH"
                        ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px" SortExpression="NUMBER_MONTH"
                        UniqueName="NUMBER_MONTH" ReadOnly="true">
                    </tlk:GridNumericColumn>
                </Columns>
            </MasterTableView>
        </tlk:RadGrid>
