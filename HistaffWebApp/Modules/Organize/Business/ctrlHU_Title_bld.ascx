<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlHU_Title_bld.ascx.vb"
    Inherits="Profile.ctrlHU_Title_bld" %>
...
<tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
    <tlk:RadPane ID="RadPane1" runat="server" Height="200px" Scrolling="None">
        ...
        <table class="table-form" onkeydown="return (event.keyCode!=13)">
            ...
            <tr>
                <td class="lb">
                    <asp:Label runat="server" ID="lbCode" Text="Mã thẻ"></asp:Label><span class="lbReq">*</span>
                </td>
                <td>
                    <tlk:RadTextBox ID="txtCode" runat="server">
                    </tlk:RadTextBox>
                    <asp:RequiredFieldValidator ID="reqCode" ControlToValidate="txtCode" runat="server"
                        ErrorMessage="Bạn phải nhập Mã thẻ" ToolTip="Bạn phải nhập Mã thẻ">
                    </asp:RequiredFieldValidator>
                    <asp:CustomValidator ID="cvalCode" ControlToValidate="txtCode" runat="server" ErrorMessage="Mã thẻ đã tồn tại."
                ...
                <td class="lb">
                    <asp:Label runat="server" ID="lbRemark" Text="Mã phòng ban"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td class="lb">
                    <asp:Label runat="server" ID="lbNameVN" Text="Tên phòng ban"></asp:Label>
                ...
                <td colspan="5">
                    ...
                    <asp:RequiredFieldValidator ID="reqNamVN" ControlToValidate="txtNameVN" runat="server"
                        ErrorMessage="Bạn phải nhập Tên phòng ban" ToolTip="Bạn phải nhập Tên phòng ban">
                    </asp:RequiredFieldValidator>
            ...
            <tr>
                <td class="lb">
                    <asp:Label runat="server" ID="Label1" Text="Họ & tên nhân viên"></asp:Label>

                </td>
                <td colspan="5">
                    <tlk:RadTextBox ID="txtNameEN" runat="server" ReadOnly="true" Width="200%">
                    </tlk:RadTextBox>
                </td>
            </tr>
        </table>
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
        <tlk:RadGrid PageSize="50" ID="rgMain" runat="server" AutoGenerateColumns="false"
            ...
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="CODE,NAME_VN,NAME_EN,REMARK,ID,EMPLOYEE_ID">
                <Columns>
