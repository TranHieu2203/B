        ...
        <tlk:RadTreeList Height="100%" EditMode="InPlace" RenderMode="Lightweight" ID="jobPosTreeList"
            ...
            <Columns>
                ...
                <tlk:TreeListBoundColumn ItemStyle-HorizontalAlign="Center"
                    HeaderStyle-HorizontalAlign="Center" DataType="System.Decimal" HeaderStyle-Width="100px"
                ...
                <tlk:TreeListBoundColumn ItemStyle-HorizontalAlign="Center"
                    HeaderStyle-HorizontalAlign="Center" DataType="System.Decimal" HeaderStyle-Width="120px"
