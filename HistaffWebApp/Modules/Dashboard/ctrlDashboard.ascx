...
<style>
    ...
    div#RadWindowWrapper_ctl00_MainContent_ctrlDashboard_rw5 td.rwWindowContent{
                ...
                <tlk:radajaxpanel id="RadAjaxPanel1" runat="server">
                    <table class="table-form">
                        <tr>
                            ...
                            <td>
                                <tlk:radcombobox id="cboOrgName2" runat="server" onclientselectedindexchanged="OnClientSelected_OrgName2" width="443px">
                                </tlk:radcombobox>
                            </td>
                        </tr>
                    </table>
    ...
    <script type="text/javascript">
        ...
        function SizeToFit(resize, isReload = 0) {
            window.setTimeout(function () {
                ...
                winH = ($("#WindowMainRegion").height() - 100);
                ...
                oWnd1.setSize(winW * 2 - 130, winH / 2 - 35);
                oWnd1.moveTo(left + 5, top + 35);
                if (i1 == 0) {
                ...
                oWnd2.setSize(winW * 2 - 130, winH / 2 - 5);
                ...
                oWnd3.setSize(winW + 100, (winH / 2) - 35);
                oWnd3.moveTo(left + winW * 2 - 110, top + 35);
                if (i3 == 0) {
                ...
                oWnd4.setSize(winW + 100, (winH / 2) - 5);
