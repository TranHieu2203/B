    ...
    <div id="left">
        ...
        <tlk:RadTreeList Height="100%" EditMode="InPlace" RenderMode="Lightweight" ID="jobPosTreeList"
            ...
            <Columns>
                ...
                <tlk:TreeListBoundColumn ItemStyle-HorizontalAlign="Right"
                    HeaderStyle-HorizontalAlign="Right" DataType="System.Decimal" HeaderStyle-Width="100px"
                    DataField="LY_FTE" UniqueName="LY_FTE" HeaderText="<%$ Translate: LY FTE %>">
                </tlk:TreeListBoundColumn>
                <tlk:TreeListBoundColumn ItemStyle-HorizontalAlign="Right"
                    HeaderStyle-HorizontalAlign="Right" DataType="System.Decimal" HeaderStyle-Width="100px"
                    DataField="TOTAL_EMP" UniqueName="TOTAL_EMP" HeaderText="<%$ Translate: Số lượng nhân viên %>"
                    ReadOnly="true">
                </tlk:TreeListBoundColumn>
                <tlk:TreeListBoundColumn ItemStyle-HorizontalAlign="Right"
                    HeaderStyle-HorizontalAlign="Right" DataType="System.Decimal" HeaderStyle-Width="130px"
                    DataField="CHENH_LECH1" UniqueName="CHENH_LECH1" HeaderText="<%$ Translate: Chênh lệch kế hoạch và thực tế %>"
                    ReadOnly="true">
                </tlk:TreeListBoundColumn>
                <tlk:TreeListBoundColumn ItemStyle-HorizontalAlign="Right"
                    HeaderStyle-HorizontalAlign="Right" DataType="System.Decimal" HeaderStyle-Width="100px"
                    DataField="TOTAL_TITLE" UniqueName="TOTAL_TITLE" HeaderText="<%$ Translate: Số lượng nhân viên kế hoạch %>"
                    ReadOnly="true">
                </tlk:TreeListBoundColumn>
                <tlk:TreeListBoundColumn ItemStyle-HorizontalAlign="Right"
                    HeaderStyle-HorizontalAlign="Right" DataType="System.Decimal" HeaderStyle-Width="130px"
                    DataField="CHENH_LECH2" UniqueName="CHENH_LECH2" HeaderText="<%$ Translate: +/- vs Plan %>"
                    ReadOnly="true">
                </tlk:TreeListBoundColumn>
