<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlHU_Abroad.ascx.vb"
    Inherits="Profile.ctrlHU_Abroad" %>
...
<tlk:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%">
    ...
    <tlk:RadPane ID="MainPane" runat="server" Scrolling="None">
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            ...
            <tlk:RadPane ID="RadPane1" runat="server" Height="340px" Scrolling="None">
                ...
                <table class="table-form">
                    ...
                    <tr>
                        <td class="item-head" colspan="6">
                            <b>
                                <%# Translate("Thông tin công tác nước ngoài")%></b>
                            <hr />
                        </td>
                    </tr>
                    <tr>
                        <td class="lb">
                            <asp:Label ID="Label2" runat="server" Text="<%$ Translate: Số quyết định %>"></asp:Label><span
                                class="lbReq">*</span>
                        </td>
                        <td>
                            <tlk:RadTextBox ID="txtDecisionNo" runat="server">
                            </tlk:RadTextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtDecisionNo"
                                runat="server" ErrorMessage="<%$ Translate: Bạn phải nhập Số quyết định. %>" ToolTip="<%$ Translate: Bạn phải nhập Số quyết định. %>"> 
                    ...
                    <tr>
                        <td class="lb">
                            <asp:Label ID="Label5" runat="server" Text="<%$ Translate: Quốc gia %>"></asp:Label><span
                                class="lbReq">*</span>
                        </td>
                        <td>
                            <tlk:RadComboBox ID="cboNation" runat="server">
                            </tlk:RadComboBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="cboNation"
                                runat="server" ErrorMessage="<%$ Translate: Bạn phải chọn Quốc gia. %>" ToolTip="<%$ Translate: Bạn phải nhập Quốc gia. %>"> 
                            </asp:RequiredFieldValidator>
                        </td>
                        <td class="lb">
                        ...
                        <td>
                            <tlk:RadNumericTextBox ID="rnTotalCost" runat="server">
                            </tlk:RadNumericTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="lb">
                            <asp:Label ID="Label7" runat="server" Text="<%$ Translate: Nội dung công việc %>"></asp:Label>
                        </td>
                        <td colspan="5">
                    ...
                    <tr>
                        <td class="lb">
                            <asp:Label ID="Label8" runat="server" Text="<%$ Translate: Tổ chức làm việc %>"></asp:Label>
                        </td>
                        <td colspan="5">
                    ...
                    <tr>
                        <td class="lb">
                            <asp:Label ID="Label9" runat="server" Text="<%$ Translate: Địa chỉ %>"></asp:Label>
                        </td>
                        <td colspan="5">
                    ...
                    <tr>
                        <td class="lb">
                            <asp:Label ID="Label10" runat="server" Text="<%$ Translate: Đơn vị tài trợ %>"></asp:Label>
                        </td>
                        <td colspan="5">
                            <tlk:RadTextBox ID="txtSponsors" runat="server" Width="100%">
                            </tlk:RadTextBox>
                        </td>
                    </tr>
                    <tr>
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadGrid PageSize="50" ID="rgMain" runat="server" AutoGenerateColumns="false"
                    ...
                    <MasterTableView DataKeyNames="ID,ORG_DESC" ClientDataKeyNames="ID,EMPLOYEE_ID,EMPLOYEE_CODE,EMPLOYEE_NAME,TITLE_NAME,ORG_NAME,MATHE_NAME,DECISION_NO,FROM_DATE,TO_DATE,NATION,NATION_NAME,
            TOTAL_COST,CONTENT,PLACE_NAME,ADDRESS,SPONSORS,REMARK">
                        <Columns>
                            ...
                            <tlk:GridBoundColumn HeaderText="Số quyết định" DataField="DECISION_NO" UniqueName="DECISION_NO"
                                HeaderStyle-Width="100px" SortExpression="DECISION_NO" />
                            ...
                            <tlk:GridBoundColumn HeaderText="Quốc gia" DataField="NATION_NAME" UniqueName="NATION_NAME"
                                HeaderStyle-Width="100px" SortExpression="NATION_NAME" />
                            <tlk:GridNumericColumn HeaderText="Chi phí" DataField="TOTAL_COST" UniqueName="TOTAL_COST"
                                HeaderStyle-Width="100px" SortExpression="TOTAL_COST" DataFormatString="{0:N0}" />
                            <tlk:GridBoundColumn HeaderText="Nội dung công việc" DataField="CONTENT" UniqueName="CONTENT"
                                HeaderStyle-Width="150px" SortExpression="CONTENT" />
                            <tlk:GridBoundColumn HeaderText="Tổ chức làm việc" DataField="PLACE_NAME" UniqueName="PLACE_NAME"
                                HeaderStyle-Width="150px" SortExpression="PLACE_NAME" />
                            <tlk:GridBoundColumn HeaderText="Địa chỉ" DataField="ADDRESS" UniqueName="ADDRESS"
                                HeaderStyle-Width="150px" SortExpression="ADDRESS" />
                            <tlk:GridBoundColumn HeaderText="Đơn vị tài trợ" DataField="SPONSORS" UniqueName="SPONSORS"
                                HeaderStyle-Width="150px" SortExpression="SPONSORS" />
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('keydown', function (e) {
            if (e.keyIdentifier == 'U+000A' || e.keyIdentifier == 'Enter' || e.keyCode == 13) {
                if (e.target.id !== 'ctl00_MainContent_ctrlHU_Abroad_txtEmployeeCode') {
                    e.preventDefault();
                    return false;
                }
            }
