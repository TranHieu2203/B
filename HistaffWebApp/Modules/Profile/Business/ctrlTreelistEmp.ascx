            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadTreeList RenderMode="Lightweight" EditMode="PopUp"  ID="rgOrgTitle" runat="server" 
                   ...
                   <Columns>
                        ...
                        <tlk:TreeListCheckBoxColumn DataField="GROUPPROJECT" UniqueName="GROUPPROJECT" HeaderText="Hội đồng" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center"></tlk:TreeListCheckBoxColumn>
