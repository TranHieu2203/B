<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlDBSeniority.ascx.vb"
    Inherits="Profile.ctrlDBSeniority" %>
...
<style>
    table#RAD_SPLITTER_RadSplitter1,td#RadPaneMain{
        border: none;
    }
</style>
<div style="margin-top: 5px; text-align: left;height:22px"> 
</div>
<div class="chart-top">
...
<%--<div class="box-headchart">
    <span class="headchart">
        <%# Translate("CTRLDBSENIORITY")%></span>
</div>--%>
...
//                oWnd.setUrl('Dialog.aspx?mid=Payroll&fid=ctrlPA_DBSalary&group=Dashboard&width=' + (winW) + '&height=' + (winH - 80) + "&noscroll=1&reload=1&resize=" + 1);
//                break;
//            case "Restore":
//                oWnd.restore();
        ...
        $(function () {
            ...
            $('#container').highcharts({
             credits: {
                ...
                title: {
                            text:'<span style="font-weight: bold;color: #767676;font-size:12px;"><%# Translate("CTRLDBSENIORITY")%></span>'
                        }
            });
        });
    }
    setTimeout(InIEvent, 200);
