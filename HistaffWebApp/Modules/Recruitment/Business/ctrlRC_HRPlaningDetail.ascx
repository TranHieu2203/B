...
<tlk:RadWindowManager ID="RadWindowManager1" runat="server">
    <Windows>
        <tlk:RadWindow runat="server" ID="rwPopup" Width="100%" VisibleStatusbar="false"
            OnClientClose="OnClientClose" Height="650px" EnableShadow="true" Behaviors="Close, Maximize, Move"
