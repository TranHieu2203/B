...
<tlk:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
                ...
                <td>
                    <asp:Panel runat="server" ID="Panel1" DefaultButton="btnSearchEmp">
                        <table class="table-form">
                            ...
                            <tr >
                                <td class="lb">
                                    <%# Translate("Nguồn ứng viên")%>
                                </td>
                                <td>
                                    <tlk:RadComboBox runat="server" ID="cboRC_SOURCE_REC_ID" ReadOnly="true" />
                                </td>
                                <td class="lb">
    ...
    <tlk:RadPane ID="DetailPane" runat="server" Scrolling="Y">
        ...
        <tlk:RadMultiPage ID="RadMultiPage1" SelectedIndex="0" runat="server" Style="margin-top: 28px"
            ...
            <tlk:RadPageView ID="rpvEmpCV" runat="server" Selected="true">
                <fieldset>
                    ...
                    <table class="table-form">
                        ...
                        <tr>
                            ...
                            <td class="lb">
                                <%# Translate("Số CMND/thẻ căn cước")%> <asp:Label runat="server" ID="IdNoRequireChar" ForeColor="Red">*</asp:Label>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="IdNoRequireField" runat="server" ErrorMessage="<%$ Translate: Bạn phải chọn Số CMND %>"
                ...
                <fieldset style="width: auto; height: auto">
                    ...
                    <table class="table-form">
                        ...
                        <tr>
                            <td class="lb">
                                <%# Translate("Email cá nhân")%> <asp:Label runat="server" ID="PerMailRequireChar" ForeColor="Red">*</asp:Label>
                            </td>
                            <td>
                                <tlk:RadTextBox ID="txtEmailCaNhan" runat="server">
                                </tlk:RadTextBox>
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtEmailCaNhan" ErrorMessage=" Bạn phải nhập Email cá nhân" ID="PerMailRequireField"></asp:RequiredFieldValidator>
                            </td>
                            <td class="lb">
                                <%# Translate("Điện thoại di dộng")%> <asp:Label runat="server" ID="MobPhoneRequireChar" ForeColor="Red">*</asp:Label>
                            </td>
                            <td>
                                <tlk:RadTextBox ID="txtSoDienThoaiCaNhan" runat="server">
                                    <ClientEvents OnKeyPress="keyPress" />
                                </tlk:RadTextBox>
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtSoDienThoaiCaNhan" ErrorMessage=" Bạn phải nhập Điện thoại di dộng" ID="MobPhoneRequireField"></asp:RequiredFieldValidator>
                            </td>
                            <td class="lb">
                        ...
                        <tr>            
                            <td></td>    
                            <td>
                                <asp:CheckBox ID="chkIsPermit" runat="server" Text="Đã có GPLĐ" AutoPostBack="true"/>
                            </td>
                        </tr>
                        <tr id="permitCtrl" runat="server"> 
                            <td class="lb">
                                <%# Translate("Số GPLĐ")%>
                            </td>       
                            <td>
                                <tlk:RadTextBox runat="server" ID="txtWorkPermitNo">
                                </tlk:RadTextBox>
                            </td>
                            <td class="lb">
                                <%# Translate("Từ ngày")%>
                ...
                <fieldset>
                    ...
                    <table class="table-form">
                        ...
                        <tr>
                            ...
                            <td class="lb">
                                <%# Translate("Trình độ học vấn")%> <asp:Label runat="server" ID="LiteracyRequireChar" ForeColor="Red">*</asp:Label>
                            </td>
                            <td>
                                <tlk:RadComboBox runat="server" ID="cboTrinhDoHocVan">
                                </tlk:RadComboBox>
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="cboTrinhDoHocVan" ErrorMessage=" Bạn phải chọn trình độ học vấn" ID="LiteracyRequireField"></asp:RequiredFieldValidator>
                            </td>
                            <td style="display: none" class="lb">
                        ...
                        <tr>
                            ...
                            <td>
                                <tlk:RadTextBox runat="server" ID="txtRate">
                                </tlk:RadTextBox>
                            </td>
                        </tr>
                        <tr style="display: none">
                ...
                <fieldset>
                    ...
                    <table class="table-form">
                        <tr >
                            ...
                            <td class="lb">
                                <%# Translate("Vị trí mong muốn 1")%><span class="lbReq">*</span>
                            </td>
                            <td>
                                <tlk:RadComboBox runat="server" ID="cboDesire_Position_1"  AutoPostBack="true" CausesValidation="false">
                                </tlk:RadComboBox>
                            </td>
                            <td class="lb" style="width: 150px">
                                <%# Translate("Vị trí mong muốn 2")%>
                            </td>
                            <td>
                                <tlk:RadComboBox runat="server" ID="cboDesire_Position_2"  AutoPostBack="true" CausesValidation="false">
                                </tlk:RadComboBox>
                            </td>
                        </tr>
                        <tr >
                        ...
                        <tr>
                              <td class="lb">
                                <%# Translate("Nơi làm việc mong muốn")%>
                            </td>
                            <td colspan="3">
                                <tlk:RadTextBox ID="txtWORK_LOCATION" runat="server" Width="100%">
                                </tlk:RadTextBox>
                            </td>
                             <%-- <td class="lb"  >
                        ...
                        <tr>
                            ...
                            <td class="lb">
                                <%# Translate("Cấp bậc mong muốn")%>
                            </td>
                            <td>
                                <tlk:RadTextBox ID="txtDesire_Level" runat="server" >
                                </tlk:RadTextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <tlk:RadTextBox runat="server" ID="txtSENIORITY_EXPERIENCE">
                                </tlk:RadTextBox>
                            </td>
                            <td class="lb">
                               <%# Translate("Đã từng làm HSV/HV")%>
                            </td>
                            <td style="padding-left: 0PX;">
                                <asp:CheckBox ID="chkWorked_HSV_HV" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="lb">
            ...
            <tlk:RadPageView ID="rpvHistory" runat="server" Width="900px" Height="600px">
                <tlk:RadSplitter ID="RadSplitter2" runat="server" Width="900px" Height="600px">
                    <tlk:RadPane ID="RadPane3" runat="server" Scrolling="None" Width="900px" Height="600px">
                        <tlk:RadGrid ID="rgDataHistory" runat="server" AllowMultiRowSelection="True" Width="100%"
                            Height="100%">
                            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID">
                                ...
                                <Columns>
                                    ...
                                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Mã yêu cầu tuyển dụng %>" DataField="CODE_RC"
                                        UniqueName="CODE_RC" />
