<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlRC_RequestNewEdit_TBP.ascx.vb"
    Inherits="Recruitment.ctrlRC_RequestNewEdit_TBP" %>
                ...
                <fieldset>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td >
                                <asp:CheckBox ID="ChkIs_Approve" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="lb">
                                <%# Translate("Người phụ trách YCTD")%>
                           </td>                         
                           <td>
                                <tlk:RadTextBox ID="txtPersonRe_TCTD" runat="server" ReadOnly="True" Width="130px">
                                </tlk:RadTextBox>
                                <tlk:RadButton EnableEmbeddedSkins="false" ID="btnFindPersonRe_TCTD" runat="server" SkinID="ButtonView" CausesValidation="false">
                                </tlk:RadButton>                                 
                            </td>
                        </tr>
                    </table>
