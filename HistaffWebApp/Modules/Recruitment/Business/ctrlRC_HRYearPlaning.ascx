<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlRC_HRYearPlaning.ascx.vb"
    Inherits="Recruitment.ctrlRC_HRYearPlaning" %>
                ...
                <tlk:RadGrid ID="rgData" runat="server" Height="100%" AllowMultiRowSelection="True">
                    <MasterTableView DataKeyNames="ID,YEAR,VERSION,EFFECT_DATE,EXPIRE_DATE" ClientDataKeyNames="ID,YEAR,VERSION,EFFECT_DATE,EXPIRE_DATE">
                        <Columns>
                            ...
                            <tlk:GridTemplateColumn HeaderText="Năm" HeaderStyle-Width="100px" DataField="YEAR" SortExpression="YEAR"
                                UniqueName="YEAR" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" >
                                <ItemTemplate>
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Ngày hiệu lực %>" DataField="EFFECT_DATE" SortExpression="EFFECT_DATE"
                                UniqueName="EFFECT_DATE" HeaderStyle-Width="170px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}" CurrentFilterFunction="EqualTo" />
