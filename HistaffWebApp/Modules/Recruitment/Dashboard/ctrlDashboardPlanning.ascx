<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlDashboardPlanning.ascx.vb"
    Inherits="Recruitment.ctrlDashboardPlanning" %>
<%@ Import Namespace="Common" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Charting" TagPrefix="telerik" %>
<asp:HiddenField ID="hidOrg" runat="server" />
<asp:HiddenField ID="hidOrgName" runat="server" />
<tlk:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%">
    <tlk:RadPane ID="LeftPane" runat="server" MinWidth="300" Width="350px" Scrolling="None" Visible="true">
            ...
            <tlk:RadPane ID="RadPane3" runat="server" Height="40px" Scrolling="None">
                <table class="table-form" onkeydown="return (event.keyCode!=13)">
                    <tr>
                        ...
                        <td>
                            <tlk:RadButton ID="btnSearch" Text="<%$ Translate: Tìm%>" runat="server" SkinID="ButtonFind" OnClientClicked="OnClientClicked">
                            </tlk:RadButton>
                        </td>
                    </tr>
                </table>
