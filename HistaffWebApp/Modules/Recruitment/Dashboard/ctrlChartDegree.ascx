...
<tlk:RadSplitter ID="RadSplitter2" runat="server" Width="100%" Height="100%">
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
        <tlk:RadSplitter ID="RadSplitter4" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            ...
            <tlk:RadPane ID="RadPane4" runat="server"  Scrolling="None" Height="300px">
               <tlk:RadChart ID="charData1" runat="server" Width="1200px" Height="300px">
            <Appearance>
            ...
            <tlk:RadPane ID="RadPane6" runat="server"  Scrolling="None" >
               <tlk:RadChart ID="RadChart1" runat="server" Width="780px" >
            <Appearance>
                <Border Visible="false" />
            </Appearance>
            <Series>
