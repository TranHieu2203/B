<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlTR_Classification.ascx.vb"
    Inherits="Training.ctrlTR_Classification" %>
<tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
        ...
        <table class="table-form">
            <tr>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="cvalCode" ControlToValidate="txtCode" runat="server" ErrorMessage="<%$ Translate:Dữ liệu đã tồn tại. %>"
                        ToolTip="<%$ Translate: Dữ liệu đã tồn tại. %>">
                    </asp:CustomValidator>
                ...
                <td>
                    ...
                    <tlk:RadComboBox runat="server" ID="cboName" CausesValidation="false">
                    </tlk:RadComboBox>
                    <asp:RequiredFieldValidator ID="reqNamVN" ControlToValidate="cboName" runat="server"
                        ErrorMessage="<%$ Translate: Bạn phải chọn Mô tả xếp loại %>" ToolTip="<%$ Translate: Bạn phải chọn Mô tả xếp loại %>">
                    </asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
        <tlk:RadGrid PageSize="50" ID="rgMain" runat="server" AutoGenerateColumns="False"
            ...
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="CODE,VALUE_FROM,VALUE_TO,EFFECT_DATE,TR_TYPE_ID">
                <Columns>
                    ...
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Mô tả xếp loại %>" DataField="TR_TYPE_NAME"
                        UniqueName="TR_TYPE_NAME" SortExpression="TR_TYPE_NAME" />
                    ...
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Ngày hiệu lực %>" DataField="EFFECT_DATE"
                        ...
                        ReadOnly="true" CurrentFilterFunction="EqualTo">
