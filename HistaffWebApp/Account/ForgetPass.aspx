<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ForgetPass.aspx.vb" Inherits="HistaffWebApp.ForgetPass1" %>
...
<body runat="server" style="height: 90%;">
    <form id="form1" runat="server">
        <tlk:RadButton ID="btnShowResendCode" runat="server" CausesValidation="false" style="display:none" />
        <asp:HiddenField ID="hidEffectTimeForCodeResetPassword" runat="server" />
        <tlk:RadStyleSheetManager ID="RadStyleSheetManager1" runat="server">
            <StyleSheets>
                ...
                <tlk:StyleSheetReference Path="~/Styles/userCustom.css" />
            </StyleSheets>
        ...
        <contenttemplate runat="server">
            <asp:Panel ID="Panel1" runat="server" DefaultButton="btnForgetPassword" BorderStyle="None" EnableViewState="true">
                <fieldset style="border: none;" runat="server">
                    <table class="table-form" style="height: 100%;margin-top:80px" runat="server">
                        <tr>
                            <td colspan="2">
                ...
                <fieldset style="border: none;">
                    <table class="table-form" style="height: 100%;margin-top:60px">
                        ...
                        <tr>
                            <td></td>
                            <td colspan="2">
                                <asp:Label ID="lbTimeRemaining" runat="server">
                                </asp:Label>
                            </td>
                        </tr>
                        <tr>
            ...
            <asp:Panel ID="Panel4" runat="server" DefaultButton="btnResendCode" Visible="false" BorderStyle="None">
                <fieldset style="border: none;">
                    <table class="table-form" style="height: 100%;margin-top:60px">
                        <tr>
                            <td colspan="3">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:Label ID="Label1" runat="server" Text="Thời gian còn lại 0s">
                                </asp:Label>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <tlk:RadButton ID="btnResendCode" runat="server" Text="<%$ Translate: Gửi lại mã%>" CausesValidation="false" />
                            </td>
                            <td>
                                <tlk:RadButton ID="btnResendCodeCancel" runat="server" Text="<%$ Translate: Bỏ qua%>" CausesValidation="false" />
                            </td>
                        </tr>
                    </table>
                </fieldset>
            ...
            <asp:Panel ID="Panel3" runat="server" DefaultButton="btnSubmidPass" Visible="false" BorderStyle="None">
                <fieldset style="border: none;">
                    <table class="table-form" style="height: 100%;margin-top:40px">
                        <tr>
                            <td colspan="3">
                        ...
                        <tr style="height: 20px">
                            <td class="lb" style="width: 140px;padding-bottom: 20px;">
                                <%# Translate("Mật khẩu mới")%><span class="lbReq" style="color: red;">*</span>
                            </td>
                            <td colspan="2">
                                <tlk:RadTextBox ID="txtPassword" MaxLength="255" runat="server" Width="95%" SkinID="TextboxPassword">
                                </tlk:RadTextBox>
                        ...
                        <tr style="height: 20px">
                            ...
                            <td colspan="2">
                                <tlk:RadTextBox ID="txtRePass" MaxLength="255" runat="server" Width="95%" SkinID="TextboxPassword">
                                </tlk:RadTextBox>
        ...
        <tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                ...
                var effectTimeForCodeResetPassword;
                var timeDown;
                var timeleft;

                function startTimer() {
                    if (document.getElementById("<%= hidEffectTimeForCodeResetPassword.ClientID %>").value) {
                        effectTimeForCodeResetPassword = document.getElementById("<%= hidEffectTimeForCodeResetPassword.ClientID %>").value;
                    }
                    else {
                        effectTimeForCodeResetPassword = 60;
                    }
                    timeleft = 0;
                ...
                function timer() {
                    if (timeleft == effectTimeForCodeResetPassword) {
                        clearInterval(timeDown);
                        var m = "";
                        var n = noty({ text: m, dismissQueue: true, type: 'warning' });
                        setTimeout(function () { $.noty.close(n.options.id); }, 10000);
                        document.getElementById("btnShowResendCode").click();
                    }
                    var lbTimeRemaining = document.getElementById('lbTimeRemaining');
                    lbTimeRemaining.innerHTML = "Thời gian còn lại " + (effectTimeForCodeResetPassword - timeleft) + "s";
                    timeleft += 1;
                };
            </script>
        </tlk:RadCodeBlock>
