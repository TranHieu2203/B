    ...
    <tlk:RadPane ID="RadPane1" runat="server" Scrolling="None">
        <tlk:RadSplitter ID="RadSplitter2" runat="server" Width="100%" Height="100%">
            ...
            <tlk:RadPane ID="RadPane3" runat="server" Scrolling="None">
                ...
                AllowSorting="false">
                <%--<tlk:RadGrid ID="rgCanSchedule"  runat="server" AutoGenerateColumns="False" AllowPaging="True" Height="380px" AllowSorting="True" AllowMultiRowSelection="true" OnPreRender="rgCanSchedule_PreRender" OnItemCreated="rgCanSchedule_ItemCreated">
