...
Partial Public Class ctrlRC_ListOfferCandidate
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents rdSendFrom As Global.Telerik.Web.UI.RadDatePicker
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents rdSendTo As Global.Telerik.Web.UI.RadDatePicker
    
    '''<summary>
    '''rdExpectedFrom control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents rdExpectedFrom As Global.Telerik.Web.UI.RadDatePicker
    
    '''<summary>
    '''rdExpectedTo control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents rdExpectedTo As Global.Telerik.Web.UI.RadDatePicker
    ...
    '''<summary>
    '''chkIsOfferletter control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents chkIsOfferletter As Global.System.Web.UI.WebControls.CheckBox
