...
Public Class ctrlRC_RequestReject
    Inherits CommonView
        ...
        Try
            ...
            For index = 0 To aListRejectID.Length - 1
                If aListRejectID(index).ToString() <> "" Then
                    Dim obj = rep.ExecuteStoreScalar("PKG_RECRUITMENT.UPDATE_REQUEST_REMARK_REJECT", New List(Of Object)({aListRejectID(index).ToString(), txtRemarkReject.Text, OUT_NUMBER}))
            ...
            If 1 = Integer.Parse(OUT_NUMBER) Then
                rep_Recruitment.UpdateStatusRequest(lstDeletes, RecruitmentCommon.RC_REQUEST_STATUS.NOT_APPROVE_ID, False)
