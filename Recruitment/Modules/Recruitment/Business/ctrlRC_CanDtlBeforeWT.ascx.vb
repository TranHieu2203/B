...
#Region "Event"
        ...
        Try
            If e.Item.ItemType = GridItemType.Item Or e.Item.ItemType = GridItemType.AlternatingItem Then
                ...
                If SelectedItem IsNot Nothing Then
                    ...
                    End If
                End If
                If datarow("FROMDATE").Text <> "" And datarow("TODATE").Text <> "" Then
                    datarow("SENORITY").Text = CalculateSeniority(datarow("FROMDATE").Text, datarow("TODATE").Text)
                End If
            End If
        Catch ex As Exception
            DisplayException(Me.ViewName, Me.ID, ex)
    ...
    Private Sub rgCandidateBeforeWT_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles rgCandidateBeforeWT.SelectedIndexChanged
        Try
            ...
            txtThamNien.Text = HttpUtility.HtmlDecode(item("SENORITY").Text)
            ...
            If item("TODATE").Text.Trim() <> "" And item("TODATE").Text <> "&nbsp;" Then
                rdTodate.SelectedDate = item("TODATE").Text
            End If
            ...
            If rnSalary.Value IsNot Nothing Then
            ...
            If rdFromdate.SelectedDate IsNot Nothing Then
                If rdTodate.SelectedDate IsNot Nothing Then
                    If rdFromdate.SelectedDate < rdTodate.SelectedDate Then
                        ...
                        txtThamNien.Text = CalculateSeniority(rdFromdate.SelectedDate, rdTodate.SelectedDate)
                    Else
