...
Public Class ctrlRC_DBEstimateReality
...
#Region "Page"
    ...
    Public Overrides Sub Refresh(Optional ByVal Message As String = "")
        ...
        Try
            ...
            StatisticData = rep.GetStatisticEstimateReality(_year)
            ...
            If StatisticData.Count > 0 Then
                ...
                For index As Integer = 0 To StatisticData.Count - 1
                    If index = StatisticData.Count - 1 Then
                        categories &= "'" & StatisticData(index).NAME & "'"
                    Else
                        categories &= "'" & StatisticData(index).NAME & "', "
                    End If
                Next
                ...
                data = "{name: 'Chi phí tuyển dụng kế hoạch', type: 'column', yAxis: 1, data: ["
                For index As Integer = 0 To StatisticData.Count - 1
                    If index = StatisticData.Count - 1 Then
                    ...
                    End If
                Next
                data &= "], tooltip: { valueSuffix: ' triệu đồng'}}, {name: 'Chi phí tuyển dụng thực tế',type: 'spline',data: ["
                For index As Integer = 0 To StatisticData.Count - 1
                    If index = StatisticData.Count - 1 Then
                        data &= StatisticData(index).VALUE_SECOND
                    Else
                        data &= StatisticData(index).VALUE_SECOND & ","
                    End If
                Next
                data &= "], tooltip: { valueSuffix: ' triệu đồng'}}"
            End If
