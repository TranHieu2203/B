...
Public Class ctrlCO_DBTop5Comp
    ...
    Public Overrides Sub Refresh(Optional ByVal Message As String = "")
        ...
        Try
            ...
            If StatisticData Is Nothing Or Message = CommonMessage.ACTION_UPDATED Then
                StatisticData = rep.GetStatisticTop5Competency(Utilities.ObjToInt(cboYear.SelectedValue))
            End If
            ...
            If StatisticData.Count > 0 Then
                ...
                data = "{name: '% nhân viên', colorByPoint: true, data: ["
