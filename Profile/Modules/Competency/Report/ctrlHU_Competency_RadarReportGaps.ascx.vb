        ...
        Try
            ...
            If cboYear.SelectedValue <> "" Then
                Using rep As New ProfileRepository
                    ...
                    If (tablePeriod IsNot Nothing And tablePeriod.Rows.Count > 0) Then
                        cboCompetencyPeriod.SelectedValue = tablePeriod.Rows(0)("ID")
                    End If
                End Using
            End If

            FillRadCombobox(cboYear1, table, "YEAR", "ID")
            cboYear1.SelectedValue = Date.Now.Year
            If cboYear1.SelectedValue <> "" Then
                Using rep As New ProfileRepository
                    ...
                    If (tablePeriod IsNot Nothing And tablePeriod.Rows.Count > 0) Then
                        cboCompetencyPeriod1.SelectedValue = tablePeriod.Rows(0)("ID")
                    End If
                End Using
            End If
        Catch ex As Exception
