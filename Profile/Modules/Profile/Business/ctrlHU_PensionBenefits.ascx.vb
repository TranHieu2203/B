...
Imports WebAppLog
Public Class ctrlHU_PensionBenefits
...
#Region "Property"
    ...
    Public Property lstID As List(Of Decimal)
        Get
            If ViewState(Me.ID & "_lstID") Is Nothing Then
                ViewState(Me.ID & "_lstID") = New List(Of Decimal)
            End If
            Return ViewState(Me.ID & "_lstID")
        End Get
        Set(ByVal value As List(Of Decimal))
            ViewState(Me.ID & "_lstID") = value
        End Set
    End Property
...
#Region "Page"
    ...
    Protected Sub InitControl()
        ...
        Try
            ...
            CType(MainToolBar.Items(0), RadToolBarButton).Text = "Tính trợ cấp"
            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                ...
                Case CommonMessage.TOOLBARITEM_DEACTIVE
                    ...
                    Using rep As New ProfileBusinessRepository
                        If rep.UpdatePensinBenefits(lstID, 1) Then
                            ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                            rgTerminate.Rebind()
                        Else
                            ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_FAIL), NotifyType.Error)
                ...
                Case CommonMessage.TOOLBARITEM_ACTIVE
                    ...
                    Next
                    Using rep As New ProfileBusinessRepository
                        If rep.UpdatePensinBenefits(lstID, 0) Then
                            ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                            rgTerminate.Rebind()
                        Else
                            ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_FAIL), NotifyType.Error)
        ...
        Try
            ...
            If isFull Then
                If Sorts IsNot Nothing Then
                    Return rep.GetPensionBenefits(_filter, _param, Sorts).ToTable()
                Else
                    Return rep.GetPensionBenefits(_filter, _param).ToTable()
                End If
            Else
                If Sorts IsNot Nothing Then
                    rgTerminate.DataSource = rep.GetPensionBenefits(_filter, rgTerminate.CurrentPageIndex,
