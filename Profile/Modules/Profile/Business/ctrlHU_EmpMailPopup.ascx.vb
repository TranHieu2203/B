...
Public Class ctrlHU_EmpMailPopup
...
#Region "Property"
    Property Email As String
        Get
            Return ViewState(Me.ID & "_Email")
        End Get
        Set(ByVal value As String)
            ViewState(Me.ID & "_Email") = value
        End Set
    End Property
    Property Empcode As String
        Get
...
#Region "Custom"
    ...
    Protected Sub CreateDataFilter(Optional ByVal isFull As Boolean = False)
        ...
        Try
            ...
            If Sorts IsNot Nothing Then
                lstEmp = rep.GetEmployeeByEmail(Email, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, _param, Sorts)
            Else
                lstEmp = rep.GetEmployeeByEmail(Email, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, _param)
            End If

            rgData.VirtualItemCount = MaximumRows
            rgData.DataSource = lstEmp
            rep.Dispose()
            _mylog.WriteLog(_mylog._info, _classPath, method, CLng(DateTime.UtcNow.Subtract(startTime).TotalSeconds).ToString(), Nothing, "")
        Catch ex As Exception
            Throw ex
    ...
    Private Sub GetParams()
        ...
        Try
            If Request.Params("EM") IsNot Nothing Then
                Me.Email = Request.Params("EM")
            End If
            If Request.Params("Empcode") IsNot Nothing Then
                Me.Empcode = Request.Params("Empcode")
            End If
            _mylog.WriteLog(_mylog._info, _classPath, method, CLng(DateTime.UtcNow.Subtract(startTime).TotalSeconds).ToString(), Nothing, "")
        Catch ex As Exception
            Throw ex
