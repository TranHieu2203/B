...
Imports WebAppLog
Public Class ctrlHU_TrainingManageNewEdit
    Inherits CommonView
            ...
            Select Case Message
                Case "UpdateView"
                    ...
                    If Contract IsNot Nothing Then
                        ...
                        txtCertificate.Text = Contract.CERTIFICATE
                        txtRemark.Text = Contract.REMARK
                        txtProgramTraining.Text = Contract.PROGRAM_TRAINING
                        txtResultTraining.Text = Contract.RESULT_TRAIN
                        rdDegree.SelectedDate = Contract.DEGREE_DATE
                        txtCost.Text = Contract.COST
                        txtUnit.Text = Contract.UNIT
                        rdDegreeExpire.SelectedDate = Contract.DEGREE_EXPIRE_DATE
...
#End Region
    ...
    Public Sub OnToolbar_Command(ByVal sender As Object, ByVal e As RadToolBarEventArgs) Handles Me.OnMainToolbarClick
        Dim objContract As New TrainningManageDTO
        Dim rep As New ProfileBusinessRepository
        Dim gID As Decimal
            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                Case CommonMessage.TOOLBARITEM_SAVE
                    If Page.IsValid Then
                        ...
                        objContract.DEGREE_DATE = rdDegree.SelectedDate
                        ...
                        Select Case CurrentState
                            Case CommonMessage.STATE_NEW
                                If rep.InsertTrainingManage(objContract, gID) Then
                                    If (isPopup) Then
                            ...
                            Case CommonMessage.STATE_EDIT
                                ...
                                If rep.ModifyTrainingManage(objContract, gID) Then
                                    If (isPopup) Then
                                        Dim str As String = "getRadWindow().close('1');"
                                        ScriptManager.RegisterStartupScript(Me.Page, Me.Page.GetType, "clientButtonClicking", str, True)
                                    Else
...
#Region "Custom"
    ...
    Private Sub GetDataCombo()
        ...
        FillDropDownList(cboContractType, ListComboData.LIST_TRAINING_FORM, "NAME_VN", "ID", Common.Common.SystemLanguage, False)
        rep.Dispose()
    End Sub
    ''' <lastupdate>
    ''' 06/07/2017 17:53
