...
Public Class ctrlHU_CB_Planning
        ...
        Try
            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                ...
                Case "COPY"
                    ...
                    If rep.CopyCBPlanning(item.GetDataKeyValue("ID")) Then
                        Refresh("UpdateView")
                    Else
...
#Region "Custom"
        ...
        Try
            Select Case CurrentState
                Case CommonMessage.STATE_DELETE
                    ...
                    Next
                    If rep.DeleteCBPlanning(lstId) Then
                        ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                        rgData.Rebind()
                        Refresh("UpdateView")
                    Else
    ...
    Protected Function CreateDataFilter(Optional ByVal isFull As Boolean = False) As DataTable
        Dim rep As New ProfileRepository
        Dim _filter As New CBPlanningDTO
        Dim startTime As DateTime = DateTime.UtcNow
        Dim method As String = System.Reflection.MethodBase.GetCurrentMethod().Name.ToString()
        Try
            ...
            If isFull Then
                If Sorts IsNot Nothing Then
                    Return rep.GetCBPlannings(_filter, Sorts).ToTable()
                Else
                    Return rep.GetCBPlannings(_filter).ToTable()
                End If
            Else
                If Sorts IsNot Nothing Then
                    rgData.DataSource = rep.GetCBPlannings(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, Sorts)
                Else
                    rgData.DataSource = rep.GetCBPlannings(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows)
                End If
