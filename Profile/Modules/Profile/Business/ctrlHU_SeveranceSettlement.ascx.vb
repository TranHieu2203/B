...
Imports WebAppLog
Public Class ctrlHU_SeveranceSettlement
...
#Region "Page"
    ...
    Protected Sub InitControl()
        ...
        Try
            ...
            CType(MainToolBar.Items(0), RadToolBarButton).Text = "Quyết toán"
        ...
        Try
            ...
            If isFull Then
                If Sorts IsNot Nothing Then
                    Return rep.GetTerminateSeverance(_filter, _param, Sorts).ToTable()
                Else
                    Return rep.GetTerminateSeverance(_filter, _param).ToTable()
                End If
            Else
                If Sorts IsNot Nothing Then
                    rgTerminate.DataSource = rep.GetTerminateSeverance(_filter, rgTerminate.CurrentPageIndex,
