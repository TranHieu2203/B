...
#Region "Page"
            ...
            Else
                Select Case Message
                    Case "UpdateView"
                        ...
                        rgMain.Rebind()
                        ClearControlValue(txtEmployeeCode, txtEmployeeName, hidID, hidEmp, txtMaThe, txtTitleName, txtOrgName, rdFromDate, rdToDate, rnDaynum, rnMoney, txtPlaceName, txtRemark)
                        CurrentState = CommonMessage.STATE_NORMAL
                    Case "InsertView"
                        ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
        ...
        Try
            ...
            Select Case CurrentState
                Case CommonMessage.STATE_NEW
                    ...
                    ClearControlValue(txtEmployeeCode, txtEmployeeName, hidID, hidEmp, txtMaThe, txtTitleName, txtOrgName, rdFromDate, rdToDate, rnDaynum, rnMoney, txtPlaceName, txtRemark)
                    EnableControlAll(True, btnEmployee, txtEmployeeCode, rdFromDate, rdToDate, rnDaynum, rnMoney, txtPlaceName, txtRemark)
                Case CommonMessage.STATE_NORMAL
                    EnabledGridNotPostback(rgMain, True)
                    txtEmployeeCode.AutoPostBack = False
                    EnableControlAll(False, btnEmployee, txtEmployeeCode, rdFromDate, rdToDate, rnDaynum, rnMoney, txtPlaceName, txtRemark)
    ...
    Public Overrides Sub BindData()
        ...
        Try
            ...
            dic.Add("DAY_NUM", rnDaynum)
            dic.Add("MONEY", rnMoney)
        ...
        Try
            Select Case CType(e.Item, RadToolBarButton).CommandName
                ...
                Case CommonMessage.TOOLBARITEM_EXPORT
                    ...
                    Using xls As New ExcelCommon
                        ...
                        If dtData.Rows.Count > 0 Then
                            rgMain.ExportExcel(Server, Response, dtData, "Travels")
                        Else
                ...
                Case CommonMessage.TOOLBARITEM_EXPORT_TEMPLATE
                    ExportTemplate("Profile\Import\Template_Import_Travel.xlsx",
                                          Nothing, Nothing, "Template_Import_Travel" & Format(Date.Now, "yyyymmdd"))
                Case CommonMessage.TOOLBARITEM_IMPORT
                    ctrlUpload1.Show()
                Case CommonMessage.TOOLBARITEM_SAVE
                    If Page.IsValid Then
                        Dim objTravel As New HUTravelDTO
                        objTravel.EMPLOYEE_ID = hidEmp.Value
                        If IsDate(rdFromDate.SelectedDate) Then
                            objTravel.FROM_DATE = rdFromDate.SelectedDate
                        End If
                        If IsDate(rdToDate.SelectedDate) Then
                            objTravel.TO_DATE = rdToDate.SelectedDate
                        End If
                        objTravel.PLACE_NAME = txtPlaceName.Text
                        If IsNumeric(rnDaynum.Value) Then
                            objTravel.DAY_NUM = rnDaynum.Value
                        End If
                        If IsNumeric(rnMoney.Value) Then
                            objTravel.MONEY = rnMoney.Value
                        End If
                        objTravel.REMARK = txtRemark.Text
                        Select Case CurrentState
                            Case CommonMessage.STATE_NEW
                                If rep.ValidateTravel(objTravel) Then
                                    ShowMessage(Translate("Dữ liệu đã tồn tại"), NotifyType.Warning)
                                    Exit Sub
                                End If
                                If rep.InsertTravel(objTravel) Then
                                    CurrentState = CommonMessage.STATE_NORMAL
                                    Refresh("InsertView")
                                    UpdateControlState()
                                Else
                            ...
                            Case CommonMessage.STATE_EDIT
                                ...
                                If rep.ModifyTravel(objTravel) Then
                                    CurrentState = CommonMessage.STATE_NORMAL
                                    Refresh("UpdateView")
                                    UpdateControlState()
                                Else
    ...
    Private Sub ctrlUpload1_OkClicked(ByVal sender As Object, ByVal e As System.EventArgs) Handles ctrlUpload1.OkClicked
        ...
        Try
            ...
            If loadToGrid() Then
                ...
                If rep.IMPORT_TRAVEL(DocXml, "") Then
        ...
        Try
            ...
            If isFull Then
                If Sorts IsNot Nothing Then
                    Return rep.GetTravels(_filter, _param, Sorts).ToTable()
                Else
                    Return rep.GetTravels(_filter, _param).ToTable()
                End If
            Else
                Dim Travels As List(Of HUTravelDTO)
                If Sorts IsNot Nothing Then
                    Travels = rep.GetTravels(_filter, rgMain.CurrentPageIndex, rgMain.PageSize, MaximumRows, _param, Sorts)
                Else
                    Travels = rep.GetTravels(_filter, rgMain.CurrentPageIndex, rgMain.PageSize, MaximumRows, _param)
                End If
    ...
    Function loadToGrid() As Boolean
        ...
        Try
            ...
            For Each row As DataRow In dtData.Rows
                ...
                If row("MONEY") IsNot DBNull.Value AndAlso row("MONEY") <> "" Then
