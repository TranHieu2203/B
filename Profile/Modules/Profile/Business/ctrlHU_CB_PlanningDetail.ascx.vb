...
Public Class ctrlHU_CB_PlanningDetail
...
#Region "Custom"
    ...
    Protected Function CreateDataFilter(Optional ByVal isFull As Boolean = False) As DataTable
        ...
        Dim _filter As New CBPlanningEmpHisDTO
        Dim startTime As DateTime = DateTime.UtcNow
        Dim method As String = System.Reflection.MethodBase.GetCurrentMethod().Name.ToString()
        Try

            _filter.CB_PLANNING_ID = hidID.value
            SetValueObjectByRadGrid(rgData, _filter)
            Dim MaximumRows As Integer
            Dim Sorts As String = rgData.MasterTableView.SortExpressions.GetSortString()
            If Sorts IsNot Nothing Then
                rgData.DataSource = rep.GetCBPlanningsHistory(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, Sorts)
            Else
                rgData.DataSource = rep.GetCBPlanningsHistory(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows)
            End If
