...
Public Class ctrlHU_TraniningManagement
        ...
        Try
            ...
            If isFull Then
                If Sorts IsNot Nothing Then
                    Return rep.GetTrainingManage(_filter, _param, Sorts).ToTable()
                Else
                    Return rep.GetTrainingManage(_filter, _param).ToTable()
                End If
            Else
                If Sorts IsNot Nothing Then
                    Me.Contracts = rep.GetTrainingManage(_filter, rgContract.CurrentPageIndex, rgContract.PageSize, MaximumRows, _param, Sorts)
                Else
                    Me.Contracts = rep.GetTrainingManage(_filter, rgContract.CurrentPageIndex, rgContract.PageSize, MaximumRows, _param)
                End If
