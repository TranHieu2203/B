...
Public Class ctrlHU_EmpDtl_HU_Allowance
    Inherits CommonView
    Protected WithEvents ViewItem As ViewBase
    ' Public Overrides Property MustAuthorize As Boolean = False

#Region "Property"
    Public Property GridList As List(Of HUAllowanceDTO)
        Get
    ...
    Public Overrides Sub Refresh(Optional ByVal Message As String = "")
        ...
        Try
            If EmployeeInfo IsNot Nothing Then
                ...
                obj.EMPLOYEE_ID = EmployeeInfo.ID
                GridList = rep.GET_EMPDTL_HU_ALLOWAMCE(obj)
            End If
