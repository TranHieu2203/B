<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlHU_Salary.ascx.vb"
    Inherits="Profile.ctrlHU_Salary" %>
        ...
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            ...
            <tlk:RadPane ID="RadPane1" runat="server" Height="60px" Scrolling="None">
                <table class="table-form">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBox ID="chkhsl" runat="server" Text="Hệ số năng suất mới nhất" />
                        </td>
                        <td>
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadGrid PageSize="50" ID="rgWorking" runat="server" AllowMultiRowSelection="true"
                    ...
                    <MasterTableView DataKeyNames="ID,EFFECT_DATE,EMPLOYEE_CODE" ClientDataKeyNames="ID,EMPLOYEE_ID">
                        <Columns>
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function OpenWage() {
            ...
            window.open('/Default.aspx?mid=Profile&fid=ctrlHU_SalaryNewEdit&group=Business' + extented, "_self"); /*
            //var pos = $("html").offset();
        ...
        function OpenWageEdit(e) {
            ...
            window.open('/Default.aspx?mid=Profile&fid=ctrlHU_SalaryNewEdit&group=Business&ID=' + id, "_self"); /*
            //var pos = $("html").offset();
            //oWindow.moveTo(pos.left, pos.top);
            oWindow.setSize(1020, $(window).height());
            oWindow.center(); */
