<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlHU_CB_PlanningNewEdit.ascx.vb"
    Inherits="Profile.ctrlHU_CB_PlanningNewEdit" %>
<%@ Import Namespace="Common" %>
<Common:ctrlMessageBox ID="ctrlMessageBox" runat="server" />
<style type="text/css">
    .ctl00_MainContent_ctrlHU_CB_PlanningNewEdit_RadTextBox1 {
        height: 100px;
    }
</style>
            ...
            <div style="width: 100%; float: left;">
                <table class="table-form">
                    ...
                    <tr>
                        <td colspan="6">
                            <b style="color: red">
                                <%# Translate("Thông tin quy hoạch CBCNV")%></b>
                            <hr />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="lb">
                            <%# Translate("Ngày hiệu lực")%>
                        </td>
                        <td>
                            <tlk:RadDatePicker runat="server" ID="rdEffectDate" Width="100%">
                            </tlk:RadDatePicker>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="rdEffectDate"
                                runat="server" ErrorMessage="<%$ Translate: Chưa nhập Ngày hiệu lực %>"
                                ToolTip="<%$ Translate: Chưa nhập Ngày hiệu lực %>"> </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="lb">
                            <%# Translate("Ngày Ký")%><span class="lbReq">*</span>
                        </td>
                        <td>
                            <tlk:RadDatePicker runat="server" ID="rdSignDate">
                            </tlk:RadDatePicker>
                            <asp:RequiredFieldValidator ID="reqEffectDate" ControlToValidate="rdSignDate"
                                runat="server" ErrorMessage="<%$ Translate: Chưa chọn Ngày ký %>"
                                ToolTip="<%$ Translate: Chưa chọn Ngày ký %>"> </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="lb">
                    ...
                    <tr>
                        <td colspan="6">
                            <b style="color: red">
                                <%# Translate("Danh sách CBCNV quy hoạch hiện tại")%></b>
                            <hr />
                        </td>
                    </tr>
                    <tr>
                        <td class="lb">
                            <%# Translate("Chức danh quy hoạch")%><span class="lbReq">*</span>
                        </td>
                        <td>
                            <tlk:RadComboBox runat="server" ID="cboPlanTitle" CausesValidation="false">
                            </tlk:RadComboBox>
                        </td>
                        <td></td>
                        <td></td>
        ...
        <tlk:RadGrid ID="rgData" AllowPaging="true" runat="server" Height="100%" Scrolling="None">
            ...
            <MasterTableView AllowPaging="false" AllowCustomPaging="false" DataKeyNames="ID,EMPLOYEE_ID,EMPLOYEE_NAME" ClientDataKeyNames="ID,EMPLOYEE_ID,EMPLOYEE_NAME" CommandItemDisplay="Top">
                ...
                <Columns>
                    ...
                    <tlk:GridBoundColumn HeaderText="Chức danh quy hoạch" DataField="TITLE_PLANNING_NAME" UniqueName="TITLE_PLANNING_NAME"
                        HeaderStyle-Width="130px" ReadOnly="true" SortExpression="TITLE_PLANNING_NAME" ItemStyle-HorizontalAlign="Center" />
                </Columns>
            </MasterTableView>
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        var splitterID = 'ctl00_MainContent_ctrlHU_CB_PlanningNewEdit_RadSplitter3';
        var pane1ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlHU_CB_PlanningNewEdit_RadPane1';
        var pane2ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlHU_CB_PlanningNewEdit_RadPane2';
        var validateID = 'MainContent_ctrlHU_CB_PlanningNewEdit_valSum';
        ...
        function btnResultHistoryClick(sender, args) {
            ...
            if (lID == null || lID == 0) {
                ...
                var oWindow = radopen('Dialog.aspx?mid=Profile&fid=ctrlHU_CB_PlanningDetail&group=Business&ID=' + lID, "rwPopup");
                var pos = $("html").offset();
