        ...
        <table class="table-form">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="cboObjectEmp"
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="cboObjectAttendant"
                        runat="server" ErrorMessage="<%$ Translate: Bạn phải chọn Đối tượng công %>"
                        ToolTip="<%$ Translate: Bạn phải chọn Đối tượng công %>"> </asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="item-head" colspan="8">
    ...
    <tlk:RadPane ID="RadPane3" runat="server" Scrolling="None">
        <tlk:RadGrid ID="rgEmployee" AllowPaging="true" AllowMultiRowEdit="true" runat="server"
            ...
            <MasterTableView EditMode="InPlace" AllowPaging="true" AllowCustomPaging="true" DataKeyNames="EMPLOYEE_ID,EMPLOYEE_NAME,TITLE_ID,ORG_ID,TITLE_NAME,ORG_NAME,EMPLOYEE_CODE,REMARK,OBJECT_ATTENDANCE_NAME,OBJECT_LABORNAME,OBJECT_ATTENDANCE,OBJECT_LABOR,OBJECT_ATTENDANT_ID,OBJECT_ATTENDANT_NAME,OBJECT_EMPLOYEE_ID,OBJECT_EMPLOYEE_NAME,WORK_PLACE_ID,WORK_PLACE_NAME"
                ClientDataKeyNames="ID,EMPLOYEE_ID,EMPLOYEE_NAME,TITLE_ID,ORG_ID,TITLE_NAME,ORG_NAME,EMPLOYEE_CODE,REMARK,OBJECT_ATTENDANCE_NAME,OBJECT_LABORNAME,OBJECT_ATTENDANCE,OBJECT_LABOR,OBJECT_ATTENDANT_ID,OBJECT_ATTENDANT_NAME,OBJECT_EMPLOYEE_ID,OBJECT_EMPLOYEE_NAME,WORK_PLACE_ID,WORK_PLACE_NAME"
                ...
                <Columns>
                    ...
                    <tlk:GridBoundColumn HeaderText="Đối tượng công" DataField="OBJECT_ATTENDANT_NAME" UniqueName="OBJECT_ATTENDANT_NAME"
