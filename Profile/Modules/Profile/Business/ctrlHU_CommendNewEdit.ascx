                ...
                <CommandItemTemplate>
                    <div style="padding: 2px 0 0 0">
                        <div style="float: left">
                            ...
                            <tlk:RadButton Width="120px" ID="btnExport" runat="server" Text="Xuất file mẫu"
                                CausesValidation="false" CommandName="Export" TabIndex="3" OnClientClicked="btnExportClicking">
                            </tlk:RadButton>
