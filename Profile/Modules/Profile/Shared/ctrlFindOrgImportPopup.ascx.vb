...
Public Class ctrlFindOrgImportPopup
    Inherits CommonView
...
#Region "Property"
    ...
    Public ReadOnly Property SelectedOrgImport As List(Of Common.CommonBusiness.OrganizationDTO)
        Get
            Using rep As New CommonRepository
                Return rep.GetListOrgImport(EmployeeListID)
            End Using
        End Get
    End Property
...
#Region "Custom"
    ...
    Public Sub Show()
        ...
        script &= "oWnd.setUrl('Dialog.aspx?mid=Profile/Shared&fid=ctrlFindOrgImportPopupDialog&noscroll=1&" & _
