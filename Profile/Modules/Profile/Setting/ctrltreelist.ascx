...
<tlk:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%">
    ...
    <tlk:RadPane ID="MainPane" runat="server" Scrolling="None">
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            <tlk:RadPane ID="RadPane1" runat="server" Visible="false" Height="40px" Scrolling="None">
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadTreeList RenderMode="Lightweight" EditMode="InPlace"  ID="rgOrgTitle" runat="server" OnNeedDataSource="RadGrid_NeedDataSource" AutoPostBack="true" 
                    ...
                    <Columns>
                        ...
                        <tlk:TreeListBoundColumn DataField="ORG_LEVEL_NAME" UniqueName="ORG_LEVEL_NAME" HeaderText="Cấp" ReadOnly ="true" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"></tlk:TreeListBoundColumn>
