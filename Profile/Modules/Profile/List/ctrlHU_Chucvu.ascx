<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlHU_Chucvu.ascx.vb"
    Inherits="Profile.ctrlHU_Chucvu" %>
...
<tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
    <tlk:RadPane ID="RadPane1" runat="server" Height="180px" Scrolling="None">
        ...
        <table class="table-form" onkeydown="return (event.keyCode!=13)">
            ...
            <tr>
                <td class="lb">
                    <asp:Label runat="server" ID="lbCode" Text="Mã chức vụ"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td class="lb">
                    <asp:Label runat="server" ID="lbNameVN" Text="Tên chức vụ (VN)"></asp:Label>
                </td>
                <td>
