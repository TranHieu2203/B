    ...
    Public Overrides Sub Refresh(Optional ByVal Message As String = "")
        Try
            ...
            If Not IsPostBack Then
                ...
                If empId = 0 Then
                    empId = LogHelper.CurrentUser.EMPLOYEE_ID
                End If
                ...
                If dtData IsNot Nothing AndAlso dtData.Rows.Count > 0 Then
                    If dtData.Rows.Count > 0 Then
                        ...
                        End If
                        EmployeeShift = rep.GetEmployeeShifts(empId, Format(dtData.Rows(0)("REGIST_DATE"), "dd/MM/yyyy"), Format(dtData.Rows(0)("REGIST_DATE"), "dd/MM/yyyy")).FirstOrDefault
                ...
                Case CommonMessage.TOOLBARITEM_SAVE
                    If Page.IsValid Then
                        If chkOtherOrg.Checked And Not IsNumeric(hidOrgID.Value) Then
                            ...
                            Exit Sub
                        End If
                        If rntbToPM.Value > 23 Then
                            ShowMessage(Translate("Lưu ý: 24:00 là 0:00!"), NotifyType.Warning)
                            Exit Sub
                        End If
                        Dim dtData As New DataTable
                        dtData = store.SE_GETTEMPLATE_APP(EmployeeID, rdRegDate.SelectedDate, Date.Now.Date, "OVERTIME", If(IsNumeric(hidOrgID.Value), hidOrgID.Value, 0))
                        If dtData.Rows.Count > 0 Then
                        ...
                        Using rep As New AttendanceRepository
                            periodid = rep.GetperiodID_2(EmployeeID, rdRegDate.SelectedDate)
                            If periodid = 0 Then
                        ...
                        Using rep As New AttendanceRepository
                            ...
                            If store.UPDATE_OT_REG(obj, CODE, LogHelper.CurrentUser.USERNAME.ToUpper, If(IsNumeric(hidOrgID.Value) AndAlso chkOtherOrg.Checked, hidOrgID.Value, 0)) Then
                                ...
                                Response.Redirect("/Default.aspx?mid=Attendance&fid=ctrlOTRegistrationNewEdit&id=0&typeUser=User")
                                'CurrentState = CommonMessage.STATE_NORMAL
                                UpdateControlState()
                            Else
        ...
        Try
            If rdRegDate.SelectedDate IsNot Nothing Then
                Using rep As New AttendanceRepository
                    ...
                    Dim validRegistDate = rep.CheckRegDateBetweenJoinAndTerDate(EmployeeID, rdRegDate.SelectedDate)
                    ...
                    Dim checkPauseOt = rep.CHECK_LEAVE_ORG_PAUSE_OT(EmployeeID, rdRegDate.SelectedDate)
