...
Public Class ctrlLeaveCTRegistration
    Inherits CommonView
            ...
            If e.ActionName = CommonMessage.TOOLBARITEM_SUBMIT And e.ButtonID = MessageBoxButtonType.ButtonYes Then
                ...
                If rgMain.SelectedItems.Count = 1 Then
                    ...
                    Try
                        ...
                        outNumber = IAttendance.PRI_PROCESS_APP(EMP_ID, period_id, "LEAVE", 0, sumday, sign_id, id_group, token)
                    Catch ex As Exception
                ...
                ElseIf rgMain.SelectedItems.Count > 1 Then
                    For Each dr As GridDataItem In rgMain.SelectedItems
                        ...
                        Try
                            Dim IAttendance As IAttendanceBusiness = New AttendanceBusinessClient()
                            outNumber = IAttendance.PRI_PROCESS_APP(dr.GetDataKeyValue("EMPLOYEE_ID"), period_id, "LEAVE", 0, sumday, sign_id, id_group, token)
                        Catch ex As Exception
                            'ShowMessage(ex.ToString, NotifyType.Error)
                            Exit For
                        End Try
        ...
        Try
            ...
            If Not isFull Then
                If Sorts IsNot Nothing Then
                    lstLeaveSheet = rep.GetLeaveCTSheet_Portal(_filter, MaximumRows, rgMain.CurrentPageIndex, rgMain.PageSize, "CREATED_DATE desc")
                Else
                    lstLeaveSheet = rep.GetLeaveCTSheet_Portal(_filter, MaximumRows, rgMain.CurrentPageIndex, rgMain.PageSize)
                End If
            Else
                Return rep.GetLeaveCTSheet_Portal(_filter).ToTable
            End If
