<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlAtAnnualLeaveEmp.ascx.vb"
    Inherits="Attendance.ctrlAtAnnualLeaveEmp" %>
...
<tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None" 
        ...
        <tlk:RadGrid PageSize=50 ID="rgDanhMuc" runat="server" AutoGenerateColumns="False" AllowPaging="True"
            ...
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID,EMPLOYEE_ID,EMPLOYEE_CODE,ANNUALLEAVE,FROMDATE_EFFECT,NOTE,ORG_NAME,TITLE_NAME,EMPLOYEE_NAME">
                <Columns>
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        var enableAjax = true;
        var splitterID = 'ctl00_MainContent_ctrlAtAnnualLeaveEmp_RadSplitter3';
        var pane1ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlAtAnnualLeaveEmp_RadPane1';
        var pane2ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlAtAnnualLeaveEmp_RadPane2';
        var validateID = 'MainContent_ctrlAtAnnualLeaveEmp_valSum';
