...
#Region "Page"
        ...
        Try
            ...
            Select Case CurrentState
                Case CommonMessage.STATE_NEW
                    ...
                    rtCodeKH.Enabled = True
                    txtNameVN.Enabled = True
                    txtdaynum.Enabled = True
                    ...
                    chkis_luong.Enabled = True
                    Chk_BHXH.Enabled = True
                    Chk_Notify.Enabled = True
                ...
                Case CommonMessage.STATE_NORMAL
                    ...
                    rtCodeKH.Enabled = False
                    txtNameVN.Enabled = False
                    txtdaynum.Enabled = False
                    ...
                    chkis_luong.Enabled = False
                    Chk_BHXH.Enabled = False
                    Chk_Notify.Enabled = False
    ...
    Public Overrides Sub BindData()
        ...
        Try
            ...
            dic.Add("CODE_KH", rtCodeKH)
            dic.Add("NAME_VN", txtNameVN)
            dic.Add("DAY_NUM", txtdaynum)
            dic.Add("IS_SALARY", chkis_luong)
            dic.Add("IS_BHXH", Chk_BHXH)
            dic.Add("IS_NOTIFY", Chk_Notify)
            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                ...
                Case CommonMessage.TOOLBARITEM_SAVE
                    If Page.IsValid Then
                        ...
                        objAT_FML.DAY_NUM = CDec(Val(txtdaynum.Text))
                        ...
                        objAT_FML.IS_SALARY = chkis_luong.Checked
                        objAT_FML.IS_BHXH = Chk_BHXH.Checked
                        objAT_FML.IS_NOTIFY = Chk_Notify.Checked
                        objAT_FML.CODE_KH = rtCodeKH.Text
                        Select Case CurrentState
                            Case CommonMessage.STATE_NEW
                                objAT_FML.ACTFLG = "A"
