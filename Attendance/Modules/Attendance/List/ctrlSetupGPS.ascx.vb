...
#Region "Page"
        ...
        Try
            ...
            If Not isFull Then
                ...
                If Sorts IsNot Nothing Then
                    Me.At_Holiday = rep.GetSetupGPS(obj, rgDanhMuc.CurrentPageIndex, rgDanhMuc.PageSize, MaximumRows, Sorts)
                Else
                    Me.At_Holiday = rep.GetSetupGPS(obj, rgDanhMuc.CurrentPageIndex, rgDanhMuc.PageSize, MaximumRows)
                End If
                rgDanhMuc.VirtualItemCount = MaximumRows
                rgDanhMuc.DataSource = Me.At_Holiday
            Else
                Return rep.GetSetupGPS(obj).ToTable
            End If
            _myLog.WriteLog(_myLog._info, _classPath, method,
                                        CLng(DateTime.UtcNow.Subtract(startTime).TotalSeconds).ToString(), Nothing, "")
        Catch ex As Exception
        ...
        Try
            ...
            Select Case CurrentState
                Case CommonMessage.STATE_NEW
                    ...
                    txtLatVD.Enabled = True
                    txtLongKD.Enabled = True
                ...
                Case CommonMessage.STATE_NORMAL
                    ...
                    txtLatVD.Enabled = False
                    txtLongKD.Enabled = False
                ...
                Case CommonMessage.STATE_DEACTIVE
                    ...
                    Next
                    If rep.ActiveSetupGPS(lstDeletes, "I") Then
                        ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                        CurrentState = CommonMessage.STATE_NORMAL
                        rgDanhMuc.Rebind()
                        ClearControlValue(txtaddress, txtLatVD, txtLongKD, txtRadius, txtNameVN, hiOrgdID)
                ...
                Case CommonMessage.STATE_ACTIVE
                    ...
                    For idx = 0 To rgDanhMuc.SelectedItems.Count - 1
                        ...
                        lstDeletes.Add(item.GetDataKeyValue("ID"))
                    Next
                    If rep.ActiveSetupGPS(lstDeletes, "A") Then
                        ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                        CurrentState = CommonMessage.STATE_NORMAL
                        rgDanhMuc.Rebind()
                        ClearControlValue(txtaddress, txtLatVD, txtLongKD, txtRadius, txtNameVN, hiOrgdID)
                ...
                Case CommonMessage.STATE_DELETE
                    ...
                    If rep.DeleteSetupGPS(lstDeletes) Then
                        Refresh("UpdateView")
                        UpdateControlState()
                    Else
                        CurrentState = CommonMessage.STATE_NORMAL
    ...
    Public Overrides Sub BindData()
        ...
        Try
            ...
            dic.Add("LAT_VD", txtLatVD)
            dic.Add("LONG_KD", txtLongKD)
            dic.Add("RADIUS", txtRadius)
                    ...
                    If Page.IsValid Then
                        ...
                        Select Case CurrentState
                            ...
                            Case CommonMessage.STATE_EDIT
                                ...
                                If rep.ModifySetupGPS(objHoliday, rgDanhMuc.SelectedValue) Then
                                    CurrentState = CommonMessage.STATE_NORMAL
    ...
    Private Sub rgDanhMuc_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles rgDanhMuc.ItemDataBound
        ...
        Try
            If e.Item.ItemType = GridItemType.Item Or e.Item.ItemType = GridItemType.AlternatingItem Then
                ...
                If datarow.GetDataKeyValue("ORG_DESC") IsNot Nothing Then
