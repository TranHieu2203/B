            ...
            Select Case CurrentState
                ...
                Case CommonMessage.STATE_DEACTIVE
                    ...
                    If rep.ActiveHoliday(lstDeletes, "I") Then
                        ...
                        CurrentState = CommonMessage.STATE_NORMAL
                        rgDanhMuc.Rebind()
                        ClearControlValue(txtCode, rdDate, rdNote, txtNameVN, chkOFFDAY)
                        rdDate.SelectedDate = Nothing
        ...
        Try
            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                Case CommonMessage.TOOLBARITEM_CREATE
                    ...
                    UpdateControlState()
                    ClearControlValue(txtNameVN, rdDate, rdNote, chkOFFDAY)
                    rdDate.Clear()
                ...
                Case CommonMessage.TOOLBARITEM_SAVE
                    If Page.IsValid Then
                        ...
                        objHoliday.OFFDAY = chkOFFDAY.Checked
                        Select Case CurrentState
                            Case CommonMessage.STATE_NEW
                            ...
                            Case CommonMessage.STATE_EDIT
                                ...
                                If rep.ValidateHoliday(Validate) Then
                                    ...
                                    ClearControlValue(txtCode, txtNameVN, txtID, rdDate, rdNote, chkOFFDAY)
                                    rdDate.SelectedDate = Nothing
                                    rgDanhMuc.Rebind()
                                    CurrentState = CommonMessage.STATE_NORMAL
                                    UpdateControlState()
