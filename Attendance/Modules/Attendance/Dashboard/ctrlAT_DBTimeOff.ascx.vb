...
#Region "Property"
    ...
    ''' </lastupdate>
    ''' <summary>
    ''' Danh sách Nghỉ phép, nghỉ bù, tổng công nghỉ
    ''' </summary>
    ''' <value></value>
    ''' <returns></returns>
    ''' <remarks></remarks>
...
#Region "Page"
    ...
    ''' </lastupdate>
    ''' <summary>
    ''' Ghi đè phương thức ViewLoad hiển thị các thành phần trên trang
    ''' </summary>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    ...
    ''' </lastupdate>
    ''' <summary>
    ''' Bind dữ liệu cho combobox year, month
    ''' Lấy danh sách các đơn vị, tổ chức cho tree view
    ''' </summary>
    ''' <remarks></remarks>
    ...
    ''' </lastupdate>
    ''' <summary>
    ''' Làm mới trang với mặc định Message =""
    ''' Lấy lại danh sách nghỉ bù, nghỉ phép, tổng công nghỉ nếu action là cập nhật
    ''' Lấy dữ liệu hiển thị trên chart
    ''' </summary>
    ...
    Public Overrides Sub Refresh(Optional ByVal Message As String = "")
        ...
        Try
            ...
            If StatisticData Is Nothing Or Message = CommonMessage.ACTION_UPDATED Then
                StatisticData = rep.GetStatisticTimeOff(Utilities.ObjToInt(cboYear.SelectedValue), Utilities.ObjToInt(cboMonth.SelectedValue))
            End If
...
#Region "Event"
    ...
    ''' </lastupdate>
    ''' <summary>
    ''' Xử lý sự kiện SelectedIndexChanged của cboMonth
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
...
#Region "Custom"
    ...
    ''' </lastupdate>
    ''' <summary>
    ''' Phương thức Load dữ liệu cho combobox cboYear
    ''' </summary>
    ''' <remarks></remarks>
