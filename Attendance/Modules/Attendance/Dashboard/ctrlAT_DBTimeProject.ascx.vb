...
Public Class ctrlAT_DBTimeProject
...
#Region "Page"
    ...
    ''' </lastupdate>
    ''' <summary>
    ''' Ghi đè phương thức ViewLoad hiển thị dữ liệu cho các control trên trang
    ''' </summary>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    ...
    ''' </lastupdate>
    ''' <summary>
    ''' Phương thức Bind dữ liệu cho các combobox, treeview
    ''' </summary>
    ''' <remarks></remarks>
    ...
    ''' </lastupdate>
    ''' <summary>
    ''' Phương thức làm mới dữ liệu cho các thành phần trên trang
    ''' Lấy dữ liệu để hiển thị bản đồ 
    ''' </summary>
    ...
    Public Overrides Sub Refresh(Optional ByVal Message As String = "")
        ...
        Try
            ...
            If StatisticData Is Nothing Or Message = CommonMessage.ACTION_UPDATED Then
                StatisticData = rep.GetStatisticTimeProject(Utilities.ObjToInt(cboYear.SelectedValue), Utilities.ObjToInt(cboMonth.SelectedValue))
            End If
