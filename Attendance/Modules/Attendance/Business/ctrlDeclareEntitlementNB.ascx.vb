...
Imports WebAppLog
Public Class ctrlDeclareEntitlementNB
...
#Region "Properties"
    Private Property REGISTER_OT As List(Of AT_DECLARE_ENTITLEMENTDTO)
        Get
    ...
    Protected Sub InitControl()
        ...
        Try
            ...
            Common.Common.BuildToolbar(Me.MainToolBar,
                                       ...
                                       ToolbarItem.Export,
                                       ToolbarItem.Delete)
            Me.MainToolBar.Items.Add(Common.Common.CreateToolbarItem("ADD_NEWS",
                                                                     ToolbarIcons.Add,
                                                                     ToolbarAuthorize.Create,
                                                                     Translate("Thêm chọn nhiều nhân viên")))
        ...
        Try
            ...
            If Not isFull Then
                If Sorts IsNot Nothing Then
                    Me.REGISTER_OT = rep.GetDelareEntitlementNB(obj, _param, MaximumRows, rgDeclareEntitlementNB.CurrentPageIndex, rgDeclareEntitlementNB.PageSize, "CREATED_DATE desc")
                Else
                    Me.REGISTER_OT = rep.GetDelareEntitlementNB(obj, _param, MaximumRows, rgDeclareEntitlementNB.CurrentPageIndex, rgDeclareEntitlementNB.PageSize)
                End If
            Else
                Return rep.GetDelareEntitlementNB(obj, _param).ToTable
            End If
