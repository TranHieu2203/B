<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlAtConcludeAnnualYear.ascx.vb"
    Inherits="Attendance.ctrlAtConcludeAnnualYear" %>
                    ...
                    <MasterTableView DataKeyNames="ID,EMPLOYEE_ID,ORG_DESC">
                        <Columns>
                            ...
                            <tlk:GridBoundColumn HeaderText="Ngày vào công ty" DataField="JOIN_DATE"
                             ...
                             <tlk:GridBoundColumn HeaderText="Năm kết phép" DataField="YEAR_CONCLUDE" UniqueName="YEAR_CONCLUDE"
                                HeaderStyle-Width="120px" SortExpression="YEAR_CONCLUDE" />
                            <tlk:GridTemplateColumn DataField="YEAR_ANNUAL" HeaderText="<%$ Translate:Số phép còn lại %>"
                                SortExpression="YEAR_ANNUAL" UniqueName="YEAR_ANNUAL">
                                <HeaderStyle HorizontalAlign="Center" Width="90px" />
                                <ItemTemplate>
                                    <tlk:RadNumericTextBox ID="txtYEAR_ANNUAL" ShowSpinButtons="false"
                                        runat="server" CausesValidation="false" Text='<%# (Eval("YEAR_ANNUAL").ToString.Replace(",", "."))%>' Width="78px">
                            ...
                            <tlk:GridTemplateColumn DataField="ANNUAL_TRANFER" HeaderText="<%$ Translate:Số phép kết chuyển %>"
                                SortExpression="ANNUAL_TRANFER" UniqueName="ANNUAL_TRANFER">
                                <HeaderStyle HorizontalAlign="Center" Width="90px" />
                                <ItemTemplate>
                                    <tlk:RadNumericTextBox ID="txtANNUAL_TRANFER" ShowSpinButtons="false"
                                        runat="server" CausesValidation="false" Text='<%# (Eval("ANNUAL_TRANFER").ToString.Replace(",", "."))%>' Width="78px">
                                         <NumberFormat AllowRounding="false" KeepNotRoundedValue="true" DecimalDigits="1" DecimalSeparator="." />
                                         <ClientEvents OnBlur="displayDecimalFormat" OnLoad="displayDecimalFormat" OnValueChanged="displayDecimalFormat" />
