...
#Region "Page"
    ...
    Protected Sub InitControl()
        ...
        Try
            ...
            MainToolBar.Items(0).Text = Translate("Thay đổi ca")
            ...
            Me.MainToolBar.Items.Add(Common.Common.CreateToolbarItem("GETDEFAULT",
                                                                     ToolbarIcons.Reset,
                                                                     ToolbarAuthorize.Import,
                                                                     Translate("Lấy ca mặc định.")))
            ...
            Select Case CurrentState
                Case CommonMessage.STATE_CHECK
                    ...
                    Dim _param = New ParamDTO With {.ORG_ID = ctrlOrganization.CurrentValue,
                                                    ...
                                                    .EMP_OBJ = cboEmpObj.SelectedValue,
        ...
        Try
            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                ...
                Case "GETDEFAULT"
                    ...
                    End If
                    If cboEmpObj.SelectedValue = "" Then
                        ShowMessage(Translate("Đối tượng nhân viên chưa được chọn"), NotifyType.Warning)
                        Exit Sub
                    End If
                    If rep.IS_PERIODSTATUS(_param) = False Then
                        ShowMessage(Translate("Kỳ công đã đóng, bạn không thể thực hiện thao tác này"), NotifyType.Error)
    ...
    Function loadToGrid(dtDataHeader As DataTable) As Boolean
        ...
        Try
            ...
            For Each row As DataRow In dtData.Rows
                ...
                End If
                If row("WS").ToString() <> "" And row("WS_I").ToString() <> "" Then
