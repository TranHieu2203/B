<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPortalApproveKPIAssessmentDetail.ascx.vb"
    Inherits="Performance.ctrlPortalApproveKPIAssessmentDetail
    " %>
    ...
    <tlk:RadPane ID="MainPane" runat="server" Scrolling="None" Height="100%">
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadGrid PageSize="50" ID="rgMngInfoEvalTarget" runat="server"   Height="100%" Width="100%"
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function SizeToFitMain() {
            ...
            $("#ctl00_MainContent_ctrlPortalApproveKPIAssessmentDetail_RadSplitter1").stop().animate({ height: winH, width: winW }, 0);
            $("#ctl00_MainContent_ctrlPortalApproveKPIAssessmentDetail_RadSplitter3").stop().animate({ height: winH, width: winW }, 0);
            $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlPortalApproveKPIAssessmentDetail_MainPane").stop().animate({ height: winH, width: winW }, 0);
            $("#ctl00_MainContent_ctrlPortalApproveKPIAssessmentDetail_rgMngInfoEvalTarget").stop().animate({ height: winH-86 }, 0);
            $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlPortalApproveKPIAssessmentDetail_RadPane2").stop().animate({ height: winH - 104 }, 0);
            $("#ctl00_MainContent_ctrlPE_PortalHTCHAssessmentDetail_rgMngInfoEvalTarget_GridData").stop().animate({ height: winH-76 }, 0);
