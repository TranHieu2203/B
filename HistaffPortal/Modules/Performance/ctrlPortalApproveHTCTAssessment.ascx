...
<tlk:RadScriptBlock ID="RadScriptBlock1" runat="server">
    <script type="text/javascript">
        ...
        function OpenView() {
            ...
            var oWindow = radopen('Dialog.aspx?mid=Performance&fid=ctrlPE_PortalHTCHAssessmentResult&FormType=2&ID=' + rg[0].getDataKeyValue('ID'), "rwPopup");
            var pos = $("html").offset();
        ...
        var winW;
         ...
         function SizeToFitMain() {
            ...
            $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlPortalApproveHTCTAssessment_MainPane").stop().animate({ height: winH, width: winW }, 0);
