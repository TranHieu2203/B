<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPortalApproveKPIAssessment.ascx.vb"
    Inherits="Performance.ctrlPortalApproveKPIAssessment
    " %>
        ...
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadGrid PageSize="50" ID="rgMngInfoEvalTarget" runat="server" Height="100%"
                    ...
                    <MasterTableView DataKeyNames="ID,EMPLOYEE,PE_PERIOD_ID,IS_CONFIRM,PORTAL_ID" ClientDataKeyNames="ID,EMPLOYEE,PE_PERIOD_ID,IS_CONFIRM,PORTAL_ID">
                        <Columns>
                            <tlk:GridClientSelectColumn UniqueName="cbStatus" HeaderStyle-HorizontalAlign="Center"
                                HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Center" />
                            <tlk:GridBoundColumn DataField="ID" Visible="false" HeaderText="ID" />
                            <tlk:GridBoundColumn HeaderText="Trạng thái" DataField="CONFIRM_NAME" SortExpression="CONFIRM_NAME"
...
<tlk:RadScriptBlock ID="RadScriptBlock1" runat="server">
    <script type="text/javascript">
        ...
        function OpenView() {
            ...
            window.open('/Default.aspx?mid=Performance&fid=ctrlPortalApproveKPIAssessmentView&ID=' + id, "_self");
        }
        ...
        function clientButtonClicking(sender, args) {
            ...
            if (args.get_item().get_commandName() == 'SYNC') {
                window.open('/Default.aspx?mid=Performance&fid=ctrlPortalApproveKPIAssessmentDetail', "_self");
            }
        ...
        function SizeToFitMain() {
            ...
            $("#ctl00_MainContent_ctrlPortalApproveKPIAssessment_RadSplitter1").stop().animate({ height: winH, width: winW }, 0);
            $("#ctl00_MainContent_ctrlPortalApproveKPIAssessment_RadSplitter3").stop().animate({ height: winH, width: winW }, 0);
            $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlPortalApproveKPIAssessment_MainPane").stop().animate({ height: winH, width: winW }, 0);
            $("#ctl00_MainContent_ctrlPortalApproveKPIAssessment_rgMngInfoEvalTarget").stop().animate({ height: winH-104, width: winW }, 0);
            $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlPortalApproveKPIAssessment_RadPane2").stop().animate({ height: winH, width: winW }, 0);
