...
<style type="text/css">
    ...
    #ctl00_MainContent_ctrlPortalDisciplineMng_MainPane  {
    vertical-align: top;
}
    #ctl00_MainContent_ctrlPortalDisciplineMng_LeftPane {
    vertical-align: top;
}
    #RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlPortalDisciplineMng_LeftPane{
        height:100%;
    }
</style>
            ...
            <tlk:RadPane ID="RadPane4" runat="server" Scrolling="None" Height="1px">
                <table class="table-form" onkeydown="return (event.keyCode!=13)" style="display:none">
                    <tr>
                        ...
                        <td>
                            <tlk:RadComboBox runat="server"  ID="cboPrintSupport">
                            </tlk:RadComboBox>
                        </td>
                        <td>
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        var winH;
           ...
           $("#ctl00_MainContent_ctrlPortalDisciplineMng_rgDiscipline").stop().animate({ height: winH-76 }, 0);
