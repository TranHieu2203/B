<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlDSVM_LISTEMP_PORTAL.ascx.vb"
    Inherits="Attendance.ctrlDSVM_LISTEMP_PORTAL" %>
                ...
                <tlk:RadGrid PageSize="50" ID="rglateCom" runat="server" Height="100%" AllowMultiRowSelection="true">
                    ...
                    <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID">
                        <Columns>
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Trạng thái %>" DataField="STATUS_NAME1" SortExpression="STATUS_NAME1" HeaderStyle-Width="100px"
                                UniqueName="STATUS_NAME1" />
                        </Columns>
                    </MasterTableView>
                </tlk:RadGrid>
            </tlk:RadPane>
    ...
    if (periodID.length = 0) {
        ...
        var winW;
         ...
         function SizeToFitMain() {
            ...
            $("#ctl00_MainContent_ctrlDSVM_LISTEMP_PORTAL_RadSplitter1").stop().animate({ height: winH, width: winW }, 0);
            $("#ctl00_MainContent_ctrlDSVM_LISTEMP_PORTAL_RadSplitter3").stop().animate({ height: winH, width: winW }, 0);
            $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlDSVM_LISTEMP_PORTAL_MainPane").stop().animate({ height: winH, width: winW }, 0);
           $("#ctl00_MainContent_ctrlDSVM_LISTEMP_PORTAL_rglateCom").stop().animate({ height: winH-125, width: winW }, 0);
            $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlDSVM_LISTEMP_PORTAL_RadPane1").stop().animate({ height: winH, width: winW }, 0);
