            ...
            <div style="width: 65%; float: left;">
                <table class="table-form" onkeydown="return (event.keyCode!=13)">
                    ...
                    <tr>
                        ...
                        <td class="lb">
                            <%# Translate("Số phép cũ điều chỉnh")%>
                        </td>
                        <td>
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function SizeToFitMain() {
            Sys.Application.remove_load(SizeToFitMain);            winH = $(window).height() - 210;            winW = $(window).width() - 90;            $("#ctl00_MainContent_ctrlLeaveRegistrationNewEdit_RadPane1").stop().animate({ height: winH - 30, width: winW }, 0);            $("#ctl00_MainContent_ctl00_MainContent_Panel1Panel").stop().animate({ height: winH, width: winW }, 0);            $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlLeaveRegistrationNewEdit_RadPane1").stop().animate({ height: winH - 30, width: winW }, 0);            Sys.Application.add_load(SizeToFitMain);
