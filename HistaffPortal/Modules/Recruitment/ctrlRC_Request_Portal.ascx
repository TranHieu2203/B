<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlRC_Request_Portal.ascx.vb"
    Inherits="Recruitment.ctrlRC_Request_Portal" %>
    ...
    <tlk:RadPane ID="MainPane" runat="server" Scrolling="None">
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal" Scrolling="None">
            ...
            <tlk:RadPane ID="RadPane3" runat="server" Height="35px" Scrolling="None">
                <table class="table-form">
                    <tr>
                        ...
                        <td>
                            <tlk:RadDatePicker ID="rdFromDate" runat="server" CausesValidation="false">
                            </tlk:RadDatePicker>
                        </td>
                        <td class="lb">
                            <%# Translate("Đến ngày")%>
                        ...
                        <td>
                            <tlk:RadDatePicker ID="rdToDate" runat="server" CausesValidation="false">
                            </tlk:RadDatePicker>
                        ...
                        <td>
                            <tlk:RadComboBox ID="cboStatus1" runat="server" CausesValidation="false">
                            </tlk:RadComboBox>
                        </td>
                        <td>
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadGrid ID="rgData" runat="server" Height="100%" Width="100%" AllowPaging="true"
                    AllowMultiRowSelection="true">
                    <ClientSettings EnableRowHoverStyle="true">
                        <Selecting AllowRowSelect="true" />
                    </ClientSettings>
                    <MasterTableView DataKeyNames="ID"
                        ClientDataKeyNames="ID,CODE_RC,NAME_RC,REQUIRER_NAME,STATUS_ID,RC_RECRUIT_PROPERTY,RC_RECRUIT_PROPERTY_NAME,IS_OVER_LIMIT,FOREIGN_ABILITY,COMPUTER_APP_LEVEL,GENDER_PRIORITY,GENDER_PRIORITY_NAME,RECRUIT_NUMBER,UPLOAD_FILE,IS_APPROVED_CODE,IS_APPROVED">
                        <Columns>
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Người phê duyệt %>" DataField="EMPLOYEE_APPROVED_NAME"
                                SortExpression="EMPLOYEE_APPROVED_NAME" UniqueName="EMPLOYEE_APPROVED_NAME" HeaderStyle-Width="150px" />
                            ...
                            <tlk:GridBoundColumn HeaderText="Lý do hủy YCTD" DataField="REMARK_CANCEL" UniqueName="REMARK_CANCEL"
                                SortExpression="REMARK_CANCEL" Visible="true" />
                        </Columns>
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function OpenNew() {
            ...
            window.open('/Default.aspx?mid=Recruitment&fid=ctrlRC_Request_PortalNewEdit&noscroll=1&State=New&orgid=' + org + '&Org_Name=' + orgName, "_self");
        }
        ...
        function OpenEdit() {
            ...
            window.open('/Default.aspx?mid=Recruitment&fid=ctrlRC_Request_PortalNewEdit&noscroll=1&State=Edit&ID=' + id, "_self");
        ...
        function OpenCopy() {
            ...
            if (bCheck > 1)
                return 1;
            var id = $find('<%# rgData.ClientID%>').get_masterTableView().get_selectedItems()[0].getDataKeyValue('ID');
            window.open('/Default.aspx?mid=Recruitment&fid=ctrlRC_Request_PortalNewEdit&noscroll=1&State=New&COPY_REQUEST_ID=' + id, "_self");
            return 2;
        }
        ...
        function OnClientClose(oWnd, args) {
         ...
         function SizeToFitMain() {
            ...
            $("#ctl00_MainContent_ctrlRC_Request_Portal_RadSplitter1").stop().animate({ height: winH, width: winW }, 0);
            $("#ctl00_MainContent_ctrlRC_Request_Portal_RadSplitter3").stop().animate({ height: winH }, 0);
            $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlRC_Request_Portal_MainPane").stop().animate({ height: winH }, 0);
           $("#ctl00_MainContent_ctrlRC_Request_Portal_rgData").stop().animate({ height: winH-76 }, 0);
             $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlRC_Request_Portal_RadPane2").stop().animate({ height: winH - 72 }, 0);
             $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlRC_Request_Portal_LeftPane").stop().animate({ height: winH }, 0);
