...
Public Class ctrlPA_SalaryLevel_Unilever
            ...
            Using rep As New PayrollRepository
                If isFull Then
                    If Sorts IsNot Nothing Then
                        Return rep.GetSalaryLevel_Unilever(_filter, Sorts).ToTable
                    Else
                        Return rep.GetSalaryLevel_Unilever(_filter).ToTable
                    End If
                Else
                    If Sorts IsNot Nothing Then
                        Me.SalaryLevels = rep.GetSalaryLevel_Unilever(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, Sorts)
                    Else
                        Me.SalaryLevels = rep.GetSalaryLevel_Unilever(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows)
                    End If
        ...
        Try
            Select Case CurrentState
                Case CommonMessage.STATE_NEW
                    ...
                    cboTitleLevel.SelectedValue = String.Empty
                    txtRemark.Text = ""
                    rntxtOrders.Text = "1"
                    ...
                    Utilities.EnableRadCombo(cboTitleLevel, True)
                ...
                Case CommonMessage.STATE_NORMAL
                    ...
                    Utilities.EnableRadCombo(cboTitleLevel, False)
                ...
                Case CommonMessage.STATE_ACTIVE
                    ...
                    Next
                    Using rep As New PayrollRepository
                        If rep.ActiveSalaryLevel_Unilever(lstDeletes, "A", cboSalaryGroup.SelectedValue) Then
                            ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                            CurrentState = CommonMessage.STATE_NORMAL
                            rgData.Rebind()
                        Else
                ...
                Case CommonMessage.STATE_DEACTIVE
                    ...
                    Next
                    Using rep As New PayrollRepository
                        If rep.ActiveSalaryLevel_Unilever(lstDeletes, "I", cboSalaryGroup.SelectedValue) Then
                            ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                            CurrentState = CommonMessage.STATE_NORMAL
                            rgData.Rebind()
                        Else
    ...
    Public Overrides Sub BindData()
        ...
        Try
            ...
            Using rep As New PayrollRepository
                ...
                comboBoxDataDTO.GET_LIST_TITLE_LEVEL = True
                ...
                FillDropDownList(cboTitleLevel, comboBoxDataDTO.LIST_LIST_TITLE_LEVEL, "NAME_VN", "ID", Common.Common.SystemLanguage, False)
            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                ...
                Case CommonMessage.TOOLBARITEM_SAVE
                    If Page.IsValid Then
                        ...
                        objSalaryLevel.CODE = cboTitleLevel.SelectedValue
                        objSalaryLevel.NAME = If(cboTitleLevel.SelectedItem.Text = String.Empty, String.Empty, cboTitleLevel.SelectedItem.Text)
                        ...
                        Using rep As New PayrollRepository
                            Select Case CurrentState
                                Case CommonMessage.STATE_NEW
                                    ...
                                    If rep.InsertSalaryLevel_Unilever(objSalaryLevel, gID) Then
                                        CurrentState = CommonMessage.STATE_NORMAL
                                        IDSelect = gID
                                        Refresh("InsertView")
                                        UpdateControlState()
                                ...
                                Case CommonMessage.STATE_EDIT
                                    ...
                                    If rep.ModifySalaryLevel_Unilever(objSalaryLevel, gID) Then
                                        CurrentState = CommonMessage.STATE_NORMAL
        ...
        Try
            Using rep As New PayrollRepository
                If CurrentState = CommonMessage.STATE_EDIT Then
                    ...
                    _validate.CODE = cboTitleLevel.SelectedValue
                    _validate.ID = rgData.SelectedValue
                    args.IsValid = rep.ValidateSalaryLevel_Unilever(_validate)
