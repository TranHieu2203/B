            ...
            Using rep As New PayrollRepository
                If isFull Then
                    If Sorts IsNot Nothing Then
                        Return rep.GetOrgBonus(obj, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, Sorts).ToTable()
                    Else
                        Return rep.GetOrgBonus(obj, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows).ToTable()
                    End If
                Else
                    Dim SalaryTypes As New List(Of OrgBonusDTO)
                    If Sorts IsNot Nothing Then
                        SalaryTypes = rep.GetOrgBonus(obj, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, Sorts)
                    Else
                        SalaryTypes = rep.GetOrgBonus(obj, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows)
                    End If
        ...
        Try
            Select Case CurrentState
                Case CommonMessage.STATE_NEW
                    ...
                    EnableControlAll(True, txtCode, txtName, txtRemark, rntxtOrders)
                ...
                Case CommonMessage.STATE_NORMAL
                    ...
                    EnableControlAll(False, txtCode, txtName, txtRemark, rntxtOrders)
                ...
                Case CommonMessage.STATE_DELETE
                    ...
                    Next
                    Using rep As New PayrollRepository
                        If rep.DeleteOrgBonus(lstDeletes) Then
                            Refresh("UpdateView")
                            UpdateControlState()
                        Else
                            CurrentState = CommonMessage.STATE_NORMAL
                ...
                Case CommonMessage.STATE_ACTIVE
                    ...
                    Next
                    Using rep As New PayrollRepository
                        If rep.ActiveOrgBonus(lstDeletes, "A") Then
                            ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                            CurrentState = CommonMessage.STATE_NORMAL
                            rgData.Rebind()
                        Else
                ...
                Case CommonMessage.STATE_DEACTIVE
                    ...
                    Next
                    Using rep As New PayrollRepository
                        If rep.ActiveOrgBonus(lstDeletes, "I") Then
                            ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                            CurrentState = CommonMessage.STATE_NORMAL
                            rgData.Rebind()
                        Else
...
#Region "Event"
    Protected Sub OnToolbar_Command(ByVal sender As Object, ByVal e As RadToolBarEventArgs) Handles Me.OnMainToolbarClick
        Dim objBonusDTO As New OrgBonusDTO
        Dim gID As Decimal
                ...
                Case CommonMessage.TOOLBARITEM_EXPORT
                    ...
                    Using xls As New ExcelCommon
                        ...
                        If dtData.Rows.Count > 0 Then
                            rgData.ExportExcel(Server, Response, dtData, "ORGBONUS")
                        End If
                    End Using
                Case CommonMessage.TOOLBARITEM_SAVE
                    If Page.IsValid Then
                        objBonusDTO.CODE = txtCode.Text
                        objBonusDTO.NAME = txtName.Text
                        objBonusDTO.REMARK = txtRemark.Text
                        objBonusDTO.ORDERS = If(rntxtOrders.Text = "", 1, Decimal.Parse(rntxtOrders.Text))
                        Using rep As New PayrollRepository
                            Select Case CurrentState
                                Case CommonMessage.STATE_NEW
                                    objBonusDTO.ACTFLG = "A"
                                    If rep.InsertOrgBonus(objBonusDTO, gID) Then
                                        CurrentState = CommonMessage.STATE_NORMAL
                                        IDSelect = gID
                                        Refresh("InsertView")
                                        UpdateControlState()
                                ...
                                Case CommonMessage.STATE_EDIT
                                    ...
                                    If rep.ModifyOrgBonus(objBonusDTO, gID) Then
                                        CurrentState = CommonMessage.STATE_NORMAL
    ...
    Private Sub cvalCode_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs) Handles cvalCode.ServerValidate
        ...
        Dim _validate As New OrgBonusDTO
        Try
            Using rep As New PayrollRepository
                If CurrentState = CommonMessage.STATE_EDIT Then
                    _validate.CODE = txtCode.Text.Trim
                    _validate.ID = rgData.SelectedValue
                    args.IsValid = rep.ValidateOrgBonus(_validate)
