...
Public Class ctrlPA_FRAME_SALARY
...
#Region "Property"
    ...
    Property Organization As PA_FRAME_SALARYDTO
        Get
            Return ViewState(Me.ID & "_Organization")
        End Get
        Set(ByVal value As PA_FRAME_SALARYDTO)
            ViewState(Me.ID & "_Organization") = value
        End Set
    End Property

    Public Property Organizations As List(Of PA_FRAME_SALARYDTO)
        Get
    ...
    Property ActiveOrganizations As List(Of PA_FRAME_SALARYDTO)
        Get
...
#Region "Page"
    ...
    Public Overrides Sub Refresh(Optional ByVal Message As String = "")
        Dim method As String = System.Reflection.MethodBase.GetCurrentMethod().Name.ToString()
        Try
            Dim lstOrganization As List(Of PA_FRAME_SALARYDTO)
            ...
            Try
                ...
                If Not IsPostBack Then
                    ...
                    lstOrganization = rep.GetFrameSalary("")
...
#Region "Event"
    ...
    Protected Sub OnToolbar_Command(ByVal sender As Object, ByVal e As RadToolBarEventArgs) Handles Me.OnMainToolbarClick
        ...
        Try
            Dim objOrgFunction As New PA_FRAME_SALARYDTO
            ...
            Try
                ...
                Select Case CType(e.Item, RadToolBarButton).CommandName
                    Case CommonMessage.TOOLBARITEM_CREATE
                        If Organizations.Count > 0 Then
                            If treeOrgFunction.SelectedNode Is Nothing Then
                                ShowMessage("Chưa chọn khung hệ số lương chức danh?", NotifyType.Warning)
                                Exit Sub
                            End If
                    ...
                    Case CommonMessage.TOOLBARITEM_SAVE
                        ...
                        End If
                        If IsNumeric(txtPromote_month.Value) Then
                            objOrgFunction.PROMOTE_MONTH = txtPromote_month.Value
                        End If
                        objOrgFunction.NEXT_CODE = txtNextCode.Text
                        ...
                        Dim objPath As PA_FRAME_SALARY_PATHDTO
                        Dim lstPath As New List(Of PA_FRAME_SALARY_PATHDTO)
                        ...
                        Select Case CurrentState
                            Case CommonMessage.STATE_NEW
                                ...
                                Dim vadidate = rep.ValidateFrameSalary(objOrgFunction)
                                ...
                                If treeOrgFunction.SelectedNode IsNot Nothing Then
                                    ...
                                    For Each line In mang
                                        Dim chuoi = rep.GetNameFrameSalary(line)
                                        str += chuoi + ";"
                                    Next
                                    str += txtNameVN.Text
                                ...
                                'GetDownLevelByNode(treeOrgFunction.Nodes(0), lstPath)
                                If rep.InsertFrameSalary(objOrgFunction, gID) Then
                                    '' số bản ghi cập nhật
                            ...
                            Case CommonMessage.STATE_EDIT
                                ...
                                If rep.ModifyFrameSalary(objOrgFunction, gID) Then
                                    Refresh("UpdateView")
                                    GetDownLevelByNode(treeOrgFunction.Nodes(0), lstPath)
                                    ' số bản ghi cập nhật
                                    Dim iSoBanGhi As Integer = 50
                                    ...
                                    For item = 0 To iTongVongLap - 1
                                        ' cập nhật từng đợt ( tối đa = số bản ghi cập nhật )
                                        Dim lstUpdate As New List(Of PA_FRAME_SALARY_PATHDTO)
                                        ...
                                        End If
                                        ' cập nhật bản ghi
                                        rep.ModifyFrameSalaryPath(lstUpdate)
                                    Next
                ...
                If CurrentState.ToUpper() = "NEW" Then
                    ClearControlValue(txtCode, txtCoefficient, txtPromote_month)
    ...
    Private Sub chkIslevel3_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkIslevel1.CheckedChanged, chkIslevel2.CheckedChanged, chkIslevel3.CheckedChanged
        If chkIslevel3.Checked Then
            ...
            txtPromote_month.Enabled = True
            txtPromote_month.ReadOnly = False
            Asterrik_Promote_month.Visible = True
            txtNextCode.Enabled = True
            txtNextCode.ReadOnly = False
            'Asterrik_NextCode.Visible = True
            reqCoefficient.Enabled = True
            'reqNextCode.Enabled = True
            ReqPromote_month.Enabled = True
        Else
            txtCoefficient.Enabled = False
            txtCoefficient.ReadOnly = True
            Asterrik_Coefficient.Visible = False
            txtPromote_month.Enabled = False
            txtPromote_month.ReadOnly = True
            Asterrik_Promote_month.Visible = False
            txtNextCode.Enabled = False
            txtNextCode.ReadOnly = True
            'Asterrik_NextCode.Visible = False
            reqCoefficient.Enabled = False
            'reqNextCode.Enabled = False
            ReqPromote_month.Enabled = False
        End If
    End Sub
...
#Region "Custom"
        ...
        Try
            ...
            Select Case sState
                Case CommonMessage.STATE_NORMAL
                    ...
                    EnableControlAll(False, txtCoefficient, txtPromote_month)
                ...
                Case CommonMessage.STATE_NEW
                    ...
                    txtREMARK.Text = ""
                    ClearControlValue(txtCoefficient, txtPromote_month)
    ...
    Private Sub FillDataByTree()
        Dim orgItem As PA_FRAME_SALARYDTO
        Dim startTime As DateTime = DateTime.UtcNow
        Dim method As String = System.Reflection.MethodBase.GetCurrentMethod().Name.ToString()
        Try
            ClearControlValue(txtCode, txtNameEN, txtNameVN, txtNextCode, txtParent_Name, txtREMARK, txtCoefficient, txtPromote_month)
            chkIslevel1.Checked = False
            chkIslevel2.Checked = False
            chkIslevel3.Checked = False
            If treeOrgFunction.SelectedNode Is Nothing Then
            ...
            If orgItem IsNot Nothing Then
                ...
                txtNextCode.Text = orgItem.NEXT_CODE
                If IsNumeric(orgItem.COEFFICIENT) Then
                    txtCoefficient.Value = Decimal.Parse(orgItem.COEFFICIENT)
                End If
                If IsNumeric(orgItem.PROMOTE_MONTH) Then
                    txtPromote_month.Value = Decimal.Parse(orgItem.PROMOTE_MONTH)
                End If
    ...
    Private Function GetUpLevelByNode(ByVal node As RadTreeNode) As PA_FRAME_SALARY_PATHDTO
        Dim method As String = System.Reflection.MethodBase.GetCurrentMethod().Name.ToString()
        ...
        Try
            ...
            Return New PA_FRAME_SALARY_PATHDTO With {.ID = Decimal.Parse(node.Value),
    ...
    Private Sub GetDownLevelByNode(ByVal node As RadTreeNode, ByRef lstPath As List(Of PA_FRAME_SALARY_PATHDTO))
        Dim method As String = System.Reflection.MethodBase.GetCurrentMethod().Name.ToString()
    ...
    Public Function GetAllChild(ByVal _orgId As Decimal) As List(Of Decimal)
        ...
        Try
            ...
            result.Add(_orgId)
            Dim lstOrgs As List(Of PA_FRAME_SALARYDTO) = Organizations
