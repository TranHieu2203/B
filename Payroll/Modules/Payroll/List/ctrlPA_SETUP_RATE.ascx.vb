...
Public Class ctrlPA_SETUP_RATE
...
#Region "Property"
    ...
    Property IDSelect As Decimal
        ...
        End Set
    End Property
    Property objlst As List(Of PA_SETUP_RATE_DTO)
        Get
            Return ViewState(Me.ID & "_objlst")
        End Get
        Set(ByVal value As List(Of PA_SETUP_RATE_DTO))
...
#Region "Page"
    ...
    Protected Function CreateDataFilter(Optional ByVal isFull As Boolean = False) As DataTable
        Dim _filter As New PA_SETUP_RATE_DTO
        Try
            ...
            Using rep As New PayrollRepository
                If isFull Then
                    If Sorts IsNot Nothing Then
                        Return rep.GetSetupRate(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, Sorts).ToTable()
                    Else
                        Return rep.GetSetupRate(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows).ToTable()
                    End If
                Else
                    If Sorts IsNot Nothing Then
                        objlst = rep.GetSetupRate(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, Sorts)
                    Else
                        objlst = rep.GetSetupRate(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows)
                    End If
        ...
        Try
            Select Case CurrentState
                Case CommonMessage.STATE_NEW
                    ...
                    EnableControlAll(True, cboBrand, rnBrand_rate, rdEffectDate, rnCom_rate, txtNOTE)

                Case CommonMessage.STATE_NORMAL
                    EnabledGridNotPostback(rgData, True)
                    EnableControlAll(False, cboBrand, rnBrand_rate, rdEffectDate, rnCom_rate, txtNOTE)
                ...
                Case CommonMessage.STATE_DELETE
                    ...
                    Next
                    Using rep As New PayrollRepository
                        If rep.DeleteSetupRate(lstDeletes) Then
                            Refresh("UpdateView")
                            UpdateControlState()
                        Else
                            CurrentState = CommonMessage.STATE_NORMAL
                        ...
                        End If
                    End Using
                    ClearControlValue(cboBrand, cboBrand, rnBrand_rate, rdEffectDate, rnCom_rate, txtNOTE)
    ...
    Public Overrides Sub BindData()
        ...
        dic.Add("COM_RATE", rnCom_rate)
        dic.Add("BRAND_RATE", rnBrand_rate)
...
#Region "Event"
    Protected Sub OnToolbar_Command(ByVal sender As Object, ByVal e As RadToolBarEventArgs) Handles Me.OnMainToolbarClick
        Dim obj As New PA_SETUP_RATE_DTO
        Dim gID As Decimal
        ...
        Try
            Select Case CType(e.Item, RadToolBarButton).CommandName
                Case CommonMessage.TOOLBARITEM_CREATE
                    ...
                    ClearControlValue(cboBrand, rnBrand_rate, rdEffectDate, rnCom_rate, txtNOTE)
                    UpdateControlState()
                ...
                Case CommonMessage.TOOLBARITEM_EXPORT
                    ...
                    Using xls As New ExcelCommon
                        ...
                        If dtData.Rows.Count > 0 Then
                            rgData.ExportExcel(Server, Response, dtData, "SETUP_BRAND_COMPANY_RATE")
                        End If
                    End Using
                Case CommonMessage.TOOLBARITEM_SAVE
                    If Page.IsValid Then
                        ...
                        obj.COM_RATE = rnCom_rate.Value
                        obj.BRAND_RATE = rnBrand_rate.Value
                        obj.NOTE = txtNOTE.Text
                        Using rep As New PayrollRepository
                            Select Case CurrentState
                                Case CommonMessage.STATE_NEW
                                    If rep.ValidateSetupRate(obj) Then
                                        If rep.InsertSetupRate(obj, gID) Then
                                            CurrentState = CommonMessage.STATE_NORMAL
                                            IDSelect = gID
                                            Refresh("InsertView")
                                            UpdateControlState()
                                        ...
                                        End If
                                    Else
                                        ShowMessage(Translate("Nhãn hàng, ngày hiệu lực đã được thiết lập"), Utilities.NotifyType.Warning)
                                    End If
                                ...
                                Case CommonMessage.STATE_EDIT
                                    ...
                                    If rep.ValidateSetupRate(obj) Then
                                        If rep.ModifySetupRate(obj, gID) Then
                                            CurrentState = CommonMessage.STATE_NORMAL
                                            IDSelect = gID
                                            Refresh("UpdateView")
                                            UpdateControlState()
