...
Public Class ctrlPA_AccountingOvertime
                ...
                Case CommonMessage.TOOLBARITEM_EXPORT
                    ...
                    Using xls As New ExcelCommon
                        ...
                        ElseIf dtData.Rows.Count > 0 Then
                            rgData.ExportExcel(Server, Response, dtData, "AccountingOvertime")
                            Exit Sub
                        End If
                    End Using
...
#Region "Custom"
            ...
            Select Case CurrentState
                Case CommonMessage.STATE_DELETE
                    ...
                    Using rep As New PayrollRepository
                        If rep.DeleteAccountingOvertime(lstDeletes) Then
                            Refresh("UpdateView")
                            UpdateControlState()
                        Else
                            CurrentState = CommonMessage.STATE_NORMAL
                ...
                Case CommonMessage.STATE_ACTIVE
                    ...
                    Next
                    Using rep As New PayrollRepository
                        If rep.ChangeStatusAccountingOvertime(lstUnLock, False) Then
                            Refresh("UpdateView")
                            UpdateControlState()
                        Else
                            CurrentState = CommonMessage.STATE_NORMAL
                ...
                Case CommonMessage.STATE_DEACTIVE
                    ...
                    Next
                    Using rep As New PayrollRepository
                        If rep.ChangeStatusAccountingOvertime(lstLock, True) Then
                            Refresh("UpdateView")
                            UpdateControlState()
                        Else
                            CurrentState = CommonMessage.STATE_NORMAL
    ...
    Protected Function CreateDataFilter(Optional ByVal isFull As Boolean = False) As DataTable
        ...
        Dim startTime As DateTime = DateTime.UtcNow
        Dim method As String = System.Reflection.MethodBase.GetCurrentMethod().Name.ToString()
        Dim _filter As New PA_Accounting_OvertimeDTO
        Try
            If ctrlOrg.CurrentValue Is Nothing Then
                rgData.DataSource = New List(Of PA_Accounting_OvertimeDTO)
                Exit Function
            End If
            ...
            Dim lstObj As New List(Of PA_Accounting_OvertimeDTO)
            If isFull Then
                If Sorts IsNot Nothing Then
                    Return rep.GetAccountingOvertime(_filter, _param, Sorts).ToTable()
                Else
                    Return rep.GetAccountingOvertime(_filter, _param).ToTable()
                End If
            Else
                If Sorts IsNot Nothing Then
                    lstObj = rep.GetAccountingOvertime(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, _param, Sorts)
                Else
                    lstObj = rep.GetAccountingOvertime(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, _param)
                End If
