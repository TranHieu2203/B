...
Public Class ctrlPA_AccountingTime
...
#Region "Custom"
            ...
            Select Case CurrentState
                Case CommonMessage.STATE_DELETE
                    ...
                    Using rep As New PayrollRepository
                        If rep.DeleteAccountingTime(lstDeletes) Then
                            Refresh("UpdateView")
                            UpdateControlState()
                        Else
                            CurrentState = CommonMessage.STATE_NORMAL
    ...
    Protected Function CreateDataFilter(Optional ByVal isFull As Boolean = False) As DataTable
        ...
        Dim startTime As DateTime = DateTime.UtcNow
        Dim method As String = System.Reflection.MethodBase.GetCurrentMethod().Name.ToString()
        Dim _filter As New PA_Accounting_TimeDTO
        Try
            If ctrlOrg.CurrentValue Is Nothing Then
                rgData.DataSource = New List(Of PA_Accounting_TimeDTO)
                Exit Function
            End If
            ...
            Dim lstObj As New List(Of PA_Accounting_TimeDTO)
            If isFull Then
                If Sorts IsNot Nothing Then
                    Return rep.GetAccountingTime(_filter, _param, Sorts).ToTable()
                Else
                    Return rep.GetAccountingTime(_filter, _param).ToTable()
                End If
            Else
                If Sorts IsNot Nothing Then
                    lstObj = rep.GetAccountingTime(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, _param, Sorts)
                Else
                    lstObj = rep.GetAccountingTime(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, _param)
                End If
