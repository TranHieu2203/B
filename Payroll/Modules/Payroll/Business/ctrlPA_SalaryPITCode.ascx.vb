...
Public Class ctrlPA_SalaryPITCode
...
#Region "Page"
    ...
    Protected Function CreateDataFilter(Optional ByVal isFull As Boolean = False) As DataTable
        ...
        Dim rep As New PayrollRepository
        Dim _filter As New PA_Salary_PITCodeDTO
        Dim startTime As DateTime = DateTime.UtcNow
        Dim method As String = System.Reflection.MethodBase.GetCurrentMethod().Name.ToString()
        Try
            ...
            If isFull Then
                If Sorts IsNot Nothing Then
                    Return rep.GetListSalPITCode(_filter, lstOrg, Sorts).ToTable()
                Else
                    Return rep.GetListSalPITCode(_filter, lstOrg).ToTable()
                End If
            Else
                Dim lstSalPit As New List(Of PA_Salary_PITCodeDTO)
                If Sorts IsNot Nothing Then
                    lstSalPit = rep.GetListSalPITCode(_filter, lstOrg, rgMain.CurrentPageIndex, rgMain.PageSize, MaximumRows, Sorts)
                Else
                    lstSalPit = rep.GetListSalPITCode(_filter, lstOrg, rgMain.CurrentPageIndex, rgMain.PageSize, MaximumRows)
                End If
                rgMain.VirtualItemCount = MaximumRows
                rgMain.DataSource = lstSalPit
            End If
            rep.Dispose()
            _mylog.WriteLog(_mylog._info, _classPath, method, CLng(DateTime.UtcNow.Subtract(startTime).TotalSeconds).ToString(), Nothing, "")
        Catch ex As Exception
        ...
        Try
            Select Case CurrentState
                Case CommonMessage.STATE_DELETE
                    ...
                    If rep.DeleteSalPITCode(lstDeletes) Then
                        Refresh("UpdateView")
                        UpdateControlState()
                    Else
                        CurrentState = CommonMessage.STATE_NORMAL
    ...
    Private Sub ctrlMessageBox_ButtonCommand(ByVal sender As Object, ByVal e As MessageBoxEventArgs) Handles ctrlMessageBox.ButtonCommand
        ...
        Try
            ...
            ElseIf e.ActionName = CommonMessage.TOOLBARITEM_LOCK And e.ButtonID = MessageBoxButtonType.ButtonYes Then
                ...
                Next
                If rep.ChangeStatusSalPITCode(lstID, -1) Then
                    ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                    rgMain.Rebind()
                Else
            ...
            ElseIf e.ActionName = CommonMessage.TOOLBARITEM_UNLOCK And e.ButtonID = MessageBoxButtonType.ButtonYes Then
                ...
                For Each item As GridDataItem In rgMain.SelectedItems
                    lstID.Add(item.GetDataKeyValue("ID"))
                Next
                If rep.ChangeStatusSalPITCode(lstID, 0) Then
                    ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                    rgMain.Rebind()
                Else
                    ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_FAIL), NotifyType.Error)
            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                ...
                Case CommonMessage.TOOLBARITEM_EXPORT
                    ...
                    Using xls As New ExcelCommon
                        ...
                        If dtData.Rows.Count > 0 Then
                            rgMain.ExportExcel(Server, Response, dtData, "Salary PIT")
                        Else
                ...
                Case CommonMessage.TOOLBARTIEM_CALCULATE
                    ...
                    If ctrlOrganization.CheckedValueKeys.Count = 0 Then
                        ...
                        Exit Sub
                    End If
                    If rep.CAL_SAL_PITCODE(ctrlOrganization.CheckedValueKeys, cbYear.SelectedValue) Then
                        ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                        rgMain.Rebind()
                    Else
                        ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_FAIL), NotifyType.Error)
