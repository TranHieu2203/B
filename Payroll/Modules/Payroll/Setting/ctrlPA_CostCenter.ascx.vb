...
Public Class ctrlPA_CostCenter
            ...
            Using rep As New PayrollRepository
                If isFull Then
                    If Sorts IsNot Nothing Then
                        Return rep.GetCostCenter(obj, Sorts).ToTable
                    Else
                        Return rep.GetCostCenter(obj).ToTable
                    End If
                Else
                    Dim CostCenters As New List(Of CostCenterDTO)
                    If Sorts IsNot Nothing Then
                        CostCenters = rep.GetCostCenter(obj, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, Sorts)
                    Else
                        CostCenters = rep.GetCostCenter(obj, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows)
                    End If
                    rgData.VirtualItemCount = MaximumRows
                    rgData.DataSource = CostCenters
                End If
            End Using
        Catch ex As Exception
            Throw ex
        ...
        Try
            Select Case CurrentState
                ...
                Case CommonMessage.STATE_DELETE
                    ...
                    Next
                    Using rep As New PayrollRepository
                        If rep.DeleteCostCenterStatus(lstDeletes, 1) Then
                            ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                            CurrentState = CommonMessage.STATE_NORMAL
                            rgData.Rebind()
                        Else
                ...
                Case CommonMessage.STATE_ACTIVE
                    ...
                    Next
                    Using rep As New PayrollRepository
                        If rep.ActiveCostCenter(lstDeletes, "A") Then
                            ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                            CurrentState = CommonMessage.STATE_NORMAL
                            rgData.Rebind()
                        Else
                ...
                Case CommonMessage.STATE_DEACTIVE
                    ...
                    Next
                    Using rep As New PayrollRepository
                        If rep.ActiveCostCenter(lstDeletes, "I") Then
                            ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                            CurrentState = CommonMessage.STATE_NORMAL
                            rgData.Rebind()
                        Else
            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                ...
                Case CommonMessage.TOOLBARITEM_EXPORT
                    ...
                    Using xls As New ExcelCommon
                        ...
                        If dtData.Rows.Count > 0 Then
                            rgData.ExportExcel(Server, Response, dtData, "CostCenter")
                        End If
                    End Using
                Case CommonMessage.TOOLBARITEM_SAVE
                    If Page.IsValid Then
                        ...
                        objCostCenter.REMARK = txtRemark.Text
                        objCostCenter.ORDERS = If(rntxtOrders.Text = "", 1, Decimal.Parse(rntxtOrders.Text))
                        Using rep As New PayrollRepository
                            Select Case CurrentState
                                Case CommonMessage.STATE_NEW
                                    objCostCenter.ACTFLG = "A"
                                    objCostCenter.IS_DELETED = 0
                                    ...
                                    End If
                                Case CommonMessage.STATE_EDIT
                                    objCostCenter.ID = rgData.SelectedValue
