<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPA_PortalSalarys.ascx.vb"
    Inherits="Payroll.ctrlPA_PortalSalarys" %>
...
<table >
    ...
    <tr>
        ...
        <td >
            <tlk:RadGrid ID="rgMain" runat="server" Height="1100px" Width="350px" AllowPaging="False" BorderStyle="None" Skin="Office2007" CssClass="RemoveBorders"
        ...
        <td>
            <tlk:RadGrid ID="rgMain1" runat="server" Height="1100px" Width="350px"  AllowPaging="False" BorderStyle="None" Skin="Office2007" CssClass="RemoveBorders"
                    AllowMultiRowSelection="true" Enabled="false" >
                    <ClientSettings EnableRowHoverStyle="true" >
                        <Selecting AllowRowSelect="false" />
                    </ClientSettings>
