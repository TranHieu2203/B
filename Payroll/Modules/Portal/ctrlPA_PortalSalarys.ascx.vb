...
Public Class ctrlPA_PortalSalarys
...
#Region "Event"
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        Try
            ...
            'End Using
            Dim ds As DataSet = hfr.ExecuteToDataSet("PKG_PA_BUSINESS.GET_PAYSLIP_PORTAL2", New List(Of Object)(New Object() {LogHelper.CurrentUser.EMPLOYEE_ID,
                                                                                                                         rcboPeriod.SelectedValue,
                                                                                                                       FrameworkUtilities.OUT_CURSOR}))
