            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                ...
                Case CommonMessage.TOOLBARITEM_SAVE
                    If Page.IsValid Then
                        ...
                        If cboStatus.SelectedValue = "" Then
                            ShowMessage(Translate("Bạn phải chọn trạng thái"), Utilities.NotifyType.Warning)
                            Exit Sub
                        End If
    ...
    Public Sub ImportData(ByVal dtData As DataTable)
        Try
            ...
            For Each row As DataRow In dtData.Rows
                ...
                '        If rep.CheckEmployeeRequest(row("EMPLOYEE_CODE").ToString, hidID.Value) Then
                '            IsError = True
            ...
            Else
                ...
                For Each item In lstDtl
                    If Not (From p In lstEmployee Where p.EMPLOYEE_ID = item.EMPLOYEE_ID).Any Then
                        ...
                        lstEmp.Add(item.EMPLOYEE_ID)
                    Else
                        isExist = True
                    End If
                Next

                Using rep1 As New CommonRepository
                    lstCommonEmployee = rep1.GetEmployeeToPopupFind_EmployeeID(lstEmp)
                End Using
