    ...
    Protected Sub InitControl()
        Try
            ...
            Common.Common.BuildToolbar(Me.MainToolBar, ToolbarItem.Create, ToolbarItem.Edit, ToolbarItem.Delete,
                                       ToolbarItem.Print, ToolbarItem.Approve, ToolbarItem.Reject, ToolbarItem.Export)
        ...
        Try
            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                ...
                Case Common.CommonMessage.TOOLBARITEM_NEXT
                    ...
                    Dim tempPath = "~/ReportTemplates//Training//Import//Import_TR_Request.xlsx"
                ...
                Case CommonMessage.TOOLBARITEM_EXPORT
                    Using xls As New ExcelCommon
                        ...
                        If dtDatas.Rows.Count > 0 Then
                            rgData.ExportExcel(Server, Response, dtDatas, "Request")
                        End If
                    End Using
            End Select
        Catch ex As Exception
    ...
    Protected Function CreateDataFilter(Optional ByVal isFull As Boolean = False) As DataTable
        ...
        Try
            ...
            If Not isFull Then
                ...
                End If
            Else
                Return rep.GetTrainingRequests(_filter, 0, rgData.PageSize, Integer.MaxValue, _param).ToTable
            End If
