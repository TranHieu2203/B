<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlTR_RequestReject.ascx.vb" EnableViewState="true" Inherits="Training.ctrlTR_RequestReject" %>
<%@ Import Namespace="Common" %>
<table class="table-form">
    <tr>
        <td>
            <%# Translate("Vui lòng nhập lý do không phê duyệt")%>:<span class="lbReq">*</span>
        </td>
    </tr>
    <tr>
        <td>
