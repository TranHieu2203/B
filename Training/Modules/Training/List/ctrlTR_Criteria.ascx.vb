...
Public Class ctrlTR_Criteria
    Inherits Common.CommonView

#Region "Property"

    Public Property Criterias As List(Of CriteriaDTO)
        Get
            Return ViewState(Me.ID & "_Criterias")
        End Get
        Set(ByVal value As List(Of CriteriaDTO))
            ViewState(Me.ID & "_Criterias") = value
        End Set
    End Property
...
#Region "Page"
    ...
    Protected Function CreateDataFilter(Optional ByVal isFull As Boolean = False) As DataTable
        ...
        Try
            ...
            Else
                If Sorts IsNot Nothing Then
                    Me.Criterias = rep.GetCriteria(_filter, rgMain.CurrentPageIndex, rgMain.PageSize, MaximumRows, Sorts)
                Else
                    Me.Criterias = rep.GetCriteria(_filter, rgMain.CurrentPageIndex, rgMain.PageSize, MaximumRows)
                End If

                rgMain.VirtualItemCount = MaximumRows
                rgMain.DataSource = Me.Criterias
            End If
        Catch ex As Exception
            Throw ex
        End Try
        ...
        Try
            Select Case CurrentState
                ...
                Case CommonMessage.STATE_DELETE
                    Dim lstDeletes As New List(Of CriteriaDTO)
                    For idx = 0 To rgMain.SelectedItems.Count - 1
                        Dim item As GridDataItem = rgMain.SelectedItems(idx)
                        lstDeletes.Add(New CriteriaDTO With {.ID = item.GetDataKeyValue("ID")})
                    Next
                ...
                Case CommonMessage.STATE_ACTIVE
                    ...
                    Next
                    If rep.ActiveCriteria(lstDeletes, True) Then
                        ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                        CurrentState = CommonMessage.STATE_NORMAL
                        rgMain.Rebind()
                    Else
                ...
                Case CommonMessage.STATE_DEACTIVE
                    ...
                    For idx = 0 To rgMain.SelectedItems.Count - 1
                        ...
                        lstDeletes.Add(item.GetDataKeyValue("ID"))
                    Next
                    If rep.ActiveCriteria(lstDeletes, False) Then
                        ShowMessage(Translate(CommonMessage.MESSAGE_TRANSACTION_SUCCESS), NotifyType.Success)
                        CurrentState = CommonMessage.STATE_NORMAL
                        rgMain.Rebind()
                    Else
            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                ...
                Case CommonMessage.TOOLBARITEM_SAVE
                    If Page.IsValid Then
                        With objCriteria
                            objCriteria.CODE = txtCode.Text
                            objCriteria.NAME = txtName.Text
                            objCriteria.REMARK = txtRemark.Text
                            objCriteria.POINT_MAX = rntxtPointMax.Value

                        End With
                        Select Case CurrentState
                            Case CommonMessage.STATE_NEW
                                objCriteria.ACTFLG = True
