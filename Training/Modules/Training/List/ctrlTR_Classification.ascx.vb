...
Public Class ctrlTR_Classification
        ...
        Try
            Select Case CurrentState
                Case CommonMessage.STATE_NEW
                    ...
                    EnableControlAll(True, txtCode, cboName, txtValue_From, txtValue_To, rdEffectDate)

                Case CommonMessage.STATE_NORMAL
                    EnabledGridNotPostback(rgMain, True)
                    EnableControlAll(False, txtCode, cboName, txtValue_From, txtValue_To, rdEffectDate)
    ...
    Public Overrides Sub BindData()
        Try
            Using rep As New TrainingRepository
                'Mô tả xếp loại
                Dim dtData = rep.GetOtherList("TR_RANK", True)
                FillRadCombobox(cboName, dtData, "NAME", "ID")
            End Using
            Dim dic As New Dictionary(Of String, Control)
            dic.Add("CODE", txtCode)
            dic.Add("TR_TYPE_ID", cboName)
        ...
        Try
            Select Case CType(e.Item, RadToolBarButton).CommandName
                Case CommonMessage.TOOLBARITEM_CREATE
                    ...
                    ClearControlValue(txtCode, cboName, txtValue_From, txtValue_To, rdEffectDate)
                    UpdateControlState()
                ...
                Case CommonMessage.TOOLBARITEM_SAVE
                    If Page.IsValid Then
                        ...
                        objClassification.TR_TYPE_ID = cboName.SelectedValue
                        ...
                        Select Case CurrentState
                            Case CommonMessage.STATE_NEW
                                ...
                                If rep.ValidateClassification(objClassification) Then
    ...
    Private Sub cvalCode_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs) Handles cvalCode.ServerValidate
        ...
        Try
            ...
            If CurrentState = CommonMessage.STATE_EDIT Then
                ...
                args.IsValid = Not rep.ValidateClassification(_validate)
            Else
                _validate.CODE = txtCode.Text.Trim
                _validate.EFFECT_DATE = rdEffectDate.SelectedDate
                args.IsValid = Not rep.ValidateClassification(_validate)
