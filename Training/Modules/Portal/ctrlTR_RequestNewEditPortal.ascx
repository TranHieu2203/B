<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlTR_RequestNewEditPortal.ascx.vb"
    Inherits="Training.ctrlTR_RequestNewEditPortal" %>
...
<%--<style type="text/css">
    #RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlTR_RequestNewEditPortal_RadPane2 
    {
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="Y">
        ...
        <table class="table-form">
            ...
            <tr>
                ...
                <td>
                    <tlk:RadNumericTextBox runat="server" ID="rntxtYear" NumberFormat-DecimalDigits="0" SkinID="number"
            ...
            <tr>
                ...
                <td>
                    <tlk:RadTextBox runat="server" ID="txtSender" ReadOnly="true" >
                    </tlk:RadTextBox>
            ...
            <tr>
                ...
                <td>
                    <tlk:RadTextBox ID="txtUpload" ReadOnly="true" runat="server" Width="55px">
                    </tlk:RadTextBox>
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('keydown', function (e) {
            if (e.keyIdentifier == 'U+000A' || e.keyIdentifier == 'Enter' || e.keyCode == 13) {
                if (e.target.id !== 'ctl00_MainContent_ctrlTR_RequestNewEditPortal_txtOrgName') {
                }
            }
        }, true);
        ...
        function SizeToFitMain() {
            Sys.Application.remove_load(SizeToFitMain);            winH = $(window).height() - 210;            winW = $(window).width() - 90;            //$("#ctl00_MainContent_ctrlTR_RequestNewEditPortal_RadSplitter3").stop().animate({ height: winH - 30, width: winW }, 0);            $("#ctl00_MainContent_ctl00_MainContent_Panel1Panel").stop().animate({ height: winH, width: winW }, 0);            $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlTR_RequestNewEditPortal_RadPane2").stop().animate({ height: winH - 30, width: winW }, 0);            Sys.Application.add_load(SizeToFitMain);
