<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlTR_PortalRequestApprove.ascx.vb"
    Inherits="Training.ctrlTR_PortalRequestApprove" %>
        ...
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadGrid ID="rgData" runat="server" Height="100%" PageSize="50" AllowPaging="true">
                    ...
                    <MasterTableView DataKeyNames="ID,STATUS_ID,REQUEST_SENDER_ID,IS_APPROVE" ClientDataKeyNames="ID,REQUEST_SENDER_ID,IS_APPROVE">
                        <Columns>
                            ...
                            <tlk:GridBoundColumn DataField="REQUEST_SENDER_ID" Visible="false" />
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function OpenEdit() {
            ...
            window.open('/Default.aspx?mid=Training&fid=ctrlTR_RequestNewEditPortal&editable=true&ID=' + id + '&PAGE=ctrlTR_PortalRequestApprove', "_self"); /*
            var pos = $("html").offset();
            oWindow.moveTo(pos.left, pos.top);
            oWindow.setSize($(window).width() - 30, $(window).height() - 30); oWindow.center(); */
            return 2;
        ...
        function SizeToFitMain() {
            ...
            $("#ctl00_MainContent_ctrlTR_PortalRequestApprove_RadSplitter1").stop().animate({ height: winH, width: winW }, 0);
            $("#ctl00_MainContent_ctrlTR_PortalRequestApprove_RadSplitter3").stop().animate({ height: winH, width: winW }, 0);
            $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlTR_PortalRequestApprove_MainPane").stop().animate({ height: winH, width: winW }, 0);
            $("#ctl00_MainContent_ctrlTR_PortalRequestApprove_rgData").stop().animate({ height: winH-76, width: winW }, 0);
            $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlTR_PortalRequestApprove_RadPane2").stop().animate({ height: winH -76 }, 0);
