<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlTR_PortalRequest.ascx.vb"
    Inherits="Training.ctrlTR_PortalRequest" %>
        ...
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            ...
            <tlk:RadPane ID="RadPane4" runat="server" Height="40px" Scrolling="None">
                <table class="table-form">
                    <tr>
                        ...
                        <td>
                            <tlk:RadNumericTextBox ID="rntYear" runat="server" NumberFormat-DecimalDigits="0" SkinID="number"
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadGrid ID="rgData" runat="server" Height="100%" PageSize="50" AllowPaging="true">
                    ...
                    <MasterTableView DataKeyNames="ID,STATUS_ID,IS_APPROVE" ClientDataKeyNames="ID">
                        <Columns>
                            ...
                            <tlk:GridBoundColumn DataField="IS_APPROVE" Visible="false" />
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Mã YCĐT %>" DataField="REQUEST_CODE"
                                SortExpression="REQUEST_CODE" UniqueName="REQUEST_CODE" HeaderStyle-Width="90px"/>
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Người phê duyệt %>" DataField="EMPLOYEE_APPROVED"
                                SortExpression="EMPLOYEE_APPROVED" UniqueName="EMPLOYEE_APPROVED" />
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Chức danh người gửi %>" DataField="SENDER_TITLE_NAME" SortExpression="SENDER_TITLE_NAME"
                                UniqueName="SENDER_TITLE_NAME" />
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Khóa đào tạo khác %>" DataField="OTHER_COURSE" SortExpression="OTHER_COURSE"
                                UniqueName="OTHER_COURSE" />
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Kế hoạch đào tạo %>" DataField="TR_PLAN_NAME"
                                SortExpression="TR_PLAN_NAME" UniqueName="TR_PLAN_NAME" HeaderStyle-Width="250px" Visible="false" />
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Công ty %>" DataField="COM_NAME"
                                SortExpression="COM_NAME" UniqueName="COM_NAME" HeaderStyle-Width="250px" Visible="false" />
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Phòng ban %>" DataField="ORG_NAME"
                                SortExpression="ORG_NAME" UniqueName="ORG_NAME" HeaderStyle-Width="250px" />
                            <tlk:GridDateTimeColumn HeaderText="<%$ Translate: Thời gian dự kiến từ %>" DataField="EXPECTED_DATE"
                                SortExpression="EXPECTED_DATE" UniqueName="EXPECTED_DATE" HeaderStyle-Width="110px"/>
                            <tlk:GridDateTimeColumn HeaderText="<%$ Translate: Thời gian dự kiến đến %>" DataField="EXPECT_DATE_TO"
                                SortExpression="EXPECT_DATE_TO" UniqueName="EXPECT_DATE_TO" />
                            <tlk:GridDateTimeColumn HeaderText="<%$ Translate: Thời gian bắt đầu %>" DataField="START_DATE"
                                SortExpression="START_DATE" UniqueName="START_DATE" HeaderStyle-Width="110px" Visible="false" />
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Đơn vị chủ trì đào tạo %>" DataField="UNIT_NAME"
                                SortExpression="UNIT_NAME" UniqueName="UNIT_NAME" HeaderStyle-Width="250px" Visible="false" />
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Số học viên dự kiến %>" DataField="TRAINER_NUMBER"
                                SortExpression="TRAINER_NUMBER" UniqueName="TRAINER_NUMBER" DataFormatString="{0:N0}" />
                            <tlk:GridCheckBoxColumn HeaderText="<%$ Translate: Cam kết đào tạo %>" DataField="TR_COMMIT"
                                SortExpression="TR_COMMIT" UniqueName="TR_COMMIT" AllowFiltering="false"/>
                            <tlk:GridCheckBoxColumn HeaderText="<%$ Translate: Bằng cấp/Chứng chỉ đạt được %>" DataField="CERTIFICATE"
                                SortExpression="CERTIFICATE" UniqueName="CERTIFICATE" AllowFiltering="false"/>
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Nơi đào tạo %>" DataField="TR_PLACE" SortExpression="TR_PLACE"
                                UniqueName="TR_PLACE" />

                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Ghi chú %>" DataField="REMARK" SortExpression="REMARK"
                                UniqueName="REMARK" />
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Lý do không duyệt %>" DataField="REASON_PORTAL"
                                SortExpression="REASON_PORTAL" UniqueName="REASON_PORTAL" />
                        </Columns>
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function OpenNew() {
            window.open('/Default.aspx?mid=Training&fid=ctrlTR_RequestNewEditPortal', "_self"); /*
            var pos = $("html").offset();
        ...
        function OpenEdit() {
            ...
            window.open('/Default.aspx?mid=Training&fid=ctrlTR_RequestNewEditPortal&editable=true&ID=' + id + '&PAGE=ctrlTR_PortalRequest', "_self"); /*
            var pos = $("html").offset();
            oWindow.moveTo(pos.left, pos.top);
            oWindow.setSize($(window).width() - 30, $(window).height() - 30); oWindow.center(); */
            return 2;
        ...
        function gridRowDblClick(sender, eventArgs) {
            var id = $find('<%# rgData.ClientID%>').get_masterTableView().get_selectedItems()[0].getDataKeyValue('ID');
            window.open('/Default.aspx?mid=Training&fid=ctrlTR_RequestNewEditPortal&ID=' + id, "_self"); /*
            var pos = $("html").offset();
            oWindow.moveTo(pos.left, pos.top);
            oWindow.setSize($(window).width() - 30, $(window).height() - 30); oWindow.center(); */
            return 0;
        ...
        function clientButtonClicking(sender, args) {
            ...
            if (args.get_item().get_commandName() == "PRINT" || args.get_item().get_commandName() == "EXPORT" || args.get_item().get_commandName() == "NEXT") {
                enableAjax = false;
            }
        ...
        function SizeToFitMain() {
            ...
            $("#ctl00_MainContent_ctrlTR_PortalRequest_RadSplitter1").stop().animate({ height: winH, width: winW }, 0);
            $("#ctl00_MainContent_ctrlTR_PortalRequest_RadSplitter3").stop().animate({ height: winH, width: winW }, 0);
            $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlTR_PortalRequest_MainPane").stop().animate({ height: winH, width: winW }, 0);
            $("#ctl00_MainContent_ctrlTR_PortalRequest_rgData").stop().animate({ height: winH-76, width: winW }, 0);
            $("#RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlTR_PortalRequest_RadPane2").stop().animate({ height: winH, width: winW }, 0);
