...
Public Class ctrlApproveProcess
    Inherits CommonView
...
#Region "Event"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Public Sub ctrlApproveProcess_OnReceiveData(ByVal sender As IViewListener(Of ViewBase), ByVal e As ViewCommunicationEventArgs) Handles Me.OnReceiveData
        Dim method As String = System.Reflection.MethodBase.GetCurrentMethod().Name.ToString()
        Dim startTime As DateTime = DateTime.UtcNow
        ...
        Try
            Select Case e.FromViewID
                Case "ctrlApproveProcessNewEdit"
