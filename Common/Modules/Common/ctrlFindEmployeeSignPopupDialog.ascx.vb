...
#Region "Property"
    ...
    Public Property EffectDate As Decimal
...
#Region "Page"
    ...
    Public Overrides Sub ViewLoad(ByVal e As System.EventArgs)
        ...
        Try
            ...
            EmployeeOrg = If(Request.Params("EmployeeOrg") Is Nothing, 0, Request.Params("EmployeeOrg"))
            EffectDate = If(Request.Params("EffectDate") Is Nothing, 0, Request.Params("EffectDate"))
...
#Region "Event"
    ...
    Protected Sub rgEmployeeInfo_NeedDataSource(ByVal sender As Object, ByVal e As GridNeedDataSourceEventArgs) Handles rgEmployeeInfo.NeedDataSource
        Try
            ...
            _filter.TER_EFFECT_DATE = Date.FromOADate(EffectDate)
            _filter.ORG_ID = EmployeeOrg
            Sorts = rgEmployeeInfo.MasterTableView.SortExpressions.GetSortString()
            If Sorts IsNot Nothing Then
                EmployeeList = rep.GetEmployeeSignToPopupFind_V2(_filter, rgEmployeeInfo.CurrentPageIndex, PageSize,
