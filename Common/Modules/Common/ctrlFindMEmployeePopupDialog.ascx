<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlFindMEmployeePopupDialog.ascx.vb"
    Inherits="Common.ctrlFindMEmployeePopupDialog" %>
            ...
            <tlk:RadPane ID="TopPanel" runat="server" Height="80px" Scrolling="None">
                <table class="table-form">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <tlk:RadButton ID="cbExpireCer" runat="server" ButtonType="ToggleButton" ToggleType="CheckBox"
                                Text="<%$ Translate: Danh sách nhân viên hết hạn chứng chỉ %>">
                            </tlk:RadButton>
                        </td>
                    </tr>
                </table>
                    ...
                    <MasterTableView DataKeyNames="ID,ORG_DESC">
                        <Columns>
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Đơn vị %>" DataField="ORG_NAME" UniqueName="ORG_NAME"
                                SortExpression="ORG_NAME" HeaderStyle-Width="130px" Visible="false" />
