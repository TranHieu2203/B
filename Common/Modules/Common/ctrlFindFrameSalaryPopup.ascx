<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlFindFrameSalaryPopup.ascx.vb"
    Inherits="Common.ctrlFindFrameSalaryPopup" %>
<%@ Register Src="ctrlFrameSalaryTree.ascx" TagName="ctrlFrameSalaryTree" TagPrefix="Common" %>
    ...
    <ContentTemplate>
        <tlk:RadAjaxPanel ID="RadAjaxPanel1" LoadingPanelID="RadAjaxLoadingPanel1" runat="server">
            <div style="height: 330px;">
                <common:ctrlFrameSalaryTree id="ctrlFrameSalary1" runat="server" />
            </div>
