...
#Region "Property"
    ...
    Property ShowInactiveUser As Boolean
        Get
            Return PageViewState(Me.ID & "_ShowInactiveUser")
        End Get
        Set(ByVal value As Boolean)
            PageViewState(Me.ID & "_ShowInactiveUser") = value
        End Set
    End Property
...
#Region "Page"
    ...
    Public Overrides Sub ViewInit(e As System.EventArgs)
        ...
        Try
            Dim startTime As DateTime = DateTime.UtcNow
            ViewItem1 = Me.Register("ctrlGroupUserN", "Common", "ctrlGroupUserN", "Secure")
    ...
    Public Sub UpdateView(Optional ByVal Message As String = "")
        ...
        Try
            ...
            ViewItem.SetProperty("ShowInactiveUser", chkShowInActiveUser.Checked)
...
#Region "Event"
    ...
    Private Sub lstGroup_SelectedIndexChanged1(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstGroup.SelectedIndexChanged
        ...
        End Try
    End Sub
    Private Sub chkShowInActiveUserp_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkShowInActiveUser.CheckedChanged
        Dim method As String = System.Reflection.MethodBase.GetCurrentMethod().Name.ToString()
        Try
            Dim startTime As DateTime = DateTime.UtcNow
            UpdateView(CommonMessage.ACTION_UPDATED)
