<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlFindFrameProductivityPopup.ascx.vb"
    Inherits="Common.ctrlFindFrameProductivityPopup" %>
<%@ Register Src="ctrlFrameProductivityTree.ascx" TagName="ctrlFrameProductivityTree" TagPrefix="Common" %>
<tlk:RadWindow runat="server" ID="rwMessage" Behaviors="None" VisibleStatusbar="false"
    Height="420" Width="400" Modal="true" Title="<%$ Translate: Tìm kiếm khung hệ số lương chức danh %>">
    <ContentTemplate>
        <tlk:RadAjaxPanel ID="RadAjaxPanel1" LoadingPanelID="RadAjaxLoadingPanel1" runat="server">
            <div style="height: 330px;">
                <common:ctrlFrameProductivityTree id="ctrlFrameProductivity1" runat="server" />
            </div>
            <div style="margin: 0px 10px 10px 10px; text-align: center;">
                ...
                <tlk:RadButton ID="btnClose" runat="server" Width="60px" Text="<%$ Translate: Đóng %>"
                    Font-Bold="true" CausesValidation="false" Visible="false">
                </tlk:RadButton>
            </div>
        </tlk:RadAjaxPanel>
