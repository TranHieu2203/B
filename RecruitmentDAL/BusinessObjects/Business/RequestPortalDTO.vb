Public Class RequestPortalDTO
    Public Property ID As Decimal
    Public Property EMPLOYEE_APPROVED As Decimal?
    Public Property EMPLOYEE_APPROVED_NAME As String
    Public Property SEND_DATE As Date?
    Public Property FROM_DATE As Date?
    Public Property TO_DATE As Date?
    Public Property IS_IN_PLAN As Decimal?
    ...
    Public Property lstEmp As List(Of RequestEmpPortalDTO)
    ...
    Public Property IS_REQUEST_COMPUTER As Boolean?
    ...
    Public Property NAME_RC As String

    Public Property REQUIRER As Decimal?
    Public Property REQUIRER_NAME As String
    Public Property RC_GRPOS As String
    Public Property WORKING_PLACE_ID As Decimal?
    Public Property WORKING_PLACE_NAME As String
    Public Property SAL_OFFER As Decimal?
    Public Property PERSON_PT_RC As Decimal?
    Public Property PERSON_PT_RC_NAME As String
    Public Property IS_APPROVED As Decimal?
    Public Property IS_APPROVED_CODE As String
    Public Property IS_APPROVED_NAME As String
    Public Property OTHER_QUALIFICATION As String
    Public Property IS_CLOCK As Decimal?
