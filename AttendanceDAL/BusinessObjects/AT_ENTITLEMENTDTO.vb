Public Class AT_ENTITLEMENTDTO
    ...
    Public Property CAL_PERIOD As Decimal?

    Public Property PERIOD_NAME As String
    Public Property WORKING_TIME_HAVE As Decimal? ' tham nien theo ngay
    Public Property BALANCE_WORKING_TIME As Decimal?  ' tham nien duoc cong theo nam
    ...
    Public Property CUR_REMAIN As Decimal?
    ...
    Public Property ADVANCELEAVE As Decimal?
    Public Property PERMISSION_FUND As Decimal?
    Public Property LEAVEOLD_PAYMENT As Decimal?
    Public Property LEAVENEW_PAYMENT As Decimal?
    Public Property LEAVERO_NUMBER As Decimal?
    Public Property LEAVE_RO As Decimal?
